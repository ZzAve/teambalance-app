...
/**
 * Container for positions management: wires the positions query and the
 * create/rename/set-kind/delete mutations to the presentational ManagePositionsView. Pure wiring — the load/error/data shells
...
export function ManagePositions() {
  ...
  const setPositionKind = useSetPositionKind()
  ...
  return (
    <ManagePositionsView
      ...
      onSetKind={(id, kind) => setPositionKind.mutate({ id, kind })}
