 ...
 *
 * When the Bunq integration lands, this is the single seam that swaps local memory for a real
 * interest endpoint — the prop-only MoneyTeaserView underneath does not change.
 */
