import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-CaGHz1tK.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./chevron-right-CKbmCLyB.js";function a({records:e=[],isLoading:t,isError:n}){let[r,a]=(0,c.useState)(!1),[f,m]=(0,c.useState)(null),[h,g]=(0,c.useState)(!1),_=e=>{m(t=>t===e?null:e),g(!1)};return(0,l.jsxs)(`section`,{children:[(0,l.jsx)(`h3`,{className:`font-display text-lg font-bold`,children:`Platform access`}),(0,l.jsx)(`p`,{className:`mt-1 text-sm text-muted-foreground`,children:`When the people who run TeamBalance worked inside your team.`}),t&&(0,l.jsx)(`p`,{className:`mt-3 text-sm text-muted-foreground`,children:`Loading…`}),n&&(0,l.jsx)(`p`,{className:`mt-3 text-sm text-red`,children:`Couldn't load platform access. Please try again.`}),!t&&!n&&(e.length===0?(0,l.jsx)(`p`,{className:`mt-3 text-sm text-muted-foreground`,children:`The TeamBalance owner has never worked in your team.`}):(0,l.jsxs)(`div`,{className:`mt-3`,children:[(0,l.jsxs)(`button`,{type:`button`,"aria-expanded":r,onClick:()=>a(e=>!e),className:`flex w-full items-center gap-2 rounded-lg border border-border bg-card p-3 text-left transition-colors hover:bg-card-hover`,children:[(0,l.jsx)(i,{size:16,className:`shrink-0 text-muted-foreground transition-transform duration-200 ${r?`rotate-90`:``}`}),(0,l.jsx)(`span`,{className:`text-sm font-medium`,children:u(e.length)})]}),r&&(0,l.jsx)(`ul`,{className:`mt-2 divide-y divide-border rounded-lg border border-border`,children:e.map(e=>{let t=`${e.enteredAt}-${e.actorKind}`,n=f===t;return(0,l.jsxs)(`li`,{children:[(0,l.jsxs)(`button`,{type:`button`,"aria-expanded":n,onClick:()=>_(t),className:`flex w-full items-center gap-2 p-3 text-left`,children:[(0,l.jsx)(i,{size:15,className:`shrink-0 text-muted-foreground transition-transform duration-200 ${n?`rotate-90`:``}`}),(0,l.jsxs)(`span`,{children:[(0,l.jsxs)(`span`,{className:`block text-sm font-medium`,children:[o(e.actorKind),` worked in your team`]}),(0,l.jsx)(`span`,{className:`block text-sm text-muted-foreground`,children:s(e)})]})]}),n&&(0,l.jsxs)(`div`,{className:`pb-3 pl-9 pr-3 text-sm`,children:[(0,l.jsxs)(`dl`,{className:`grid grid-cols-[auto_1fr] gap-x-4 gap-y-1`,children:[(0,l.jsx)(`dt`,{className:`text-muted-foreground`,children:`Started`}),(0,l.jsx)(`dd`,{children:p(new Date(e.enteredAt))}),(0,l.jsx)(`dt`,{className:`text-muted-foreground`,children:`Ended`}),(0,l.jsx)(`dd`,{children:d(e)}),(0,l.jsx)(`dt`,{className:`text-muted-foreground`,children:`Acting as`}),(0,l.jsx)(`dd`,{children:`An admin of your team`})]}),(0,l.jsx)(`button`,{type:`button`,"aria-expanded":h,onClick:()=>g(e=>!e),className:`mt-3 text-sm font-medium text-blue underline underline-offset-4`,children:`Why does this happen?`}),h&&(0,l.jsxs)(`div`,{className:`mt-2 flex flex-col gap-2 border-l-2 border-border pl-3 text-sm text-muted-foreground`,children:[(0,l.jsx)(`p`,{children:`TeamBalance is run by a small team. The owner works inside a team to set it up, prepare a season, or fix something that was reported.`}),(0,l.jsx)(`p`,{children:`Access lasts an hour at a time and is never silent — it is listed here whether or not anything changed.`})]})]})]},t)})})]}))]})}function o(e){return e===`MEMBER`?`A team member`:`The TeamBalance owner`}function s(e){let t=new Date(e.enteredAt),n=f(e);return`${p(t)} – ${t.toDateString()===n.toDateString()?m(n):p(n)}`}var c,l,u,d,f,p,m;function h(){return(h=e((()=>{c=t(),r(),l=n(),u=e=>e===1?`The TeamBalance owner worked here once`:`The TeamBalance owner worked here ${e} times`,d=e=>e.exitedAt?`${m(f(e))}, when they left`:`${m(f(e))}, when the hour ran out`,f=e=>new Date(e.exitedAt??e.lastActiveAt),p=e=>e.toLocaleString(void 0,{day:`numeric`,month:`short`,hour:`2-digit`,minute:`2-digit`}),m=e=>e.toLocaleTimeString(void 0,{hour:`2-digit`,minute:`2-digit`}),a.__docgenInfo={description:`The Admin-visible **Act-as Record** (ADR-0024 §4): what platform access this Team has had.
