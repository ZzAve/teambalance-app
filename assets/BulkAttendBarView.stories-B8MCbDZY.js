import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n}from"./event-fixtures-BaYeuP-I.js";import{n as r,t as i}from"./BulkAttendButtonView-Os5pL--W.js";function a({groups:e,onAttend:t,pendingTypeId:n=null}){return e.length===0?null:(0,o.jsx)(`div`,{className:`mt-3 flex flex-wrap items-center justify-end gap-2`,children:e.map(e=>(0,o.jsx)(i,{count:e.events.length,typeName:e.typeName,isPending:n===e.typeId,onAttend:()=>t(e.typeId)},e.typeId))})}var o;function s(){return(s=e((()=>{r(),o=t(),a.__docgenInfo={description:`One "Attend N <type>" button per event type with blanks left (ADR-0021).
