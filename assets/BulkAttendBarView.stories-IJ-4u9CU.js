import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{i as n,r}from"./event-fixtures-GLq-GGnS.js";import{n as i,t as a}from"./BulkAttendButtonView-BFYjO9mb.js";function o({groups:e,onAttend:t,pendingTypeId:n=null}){return e.length===0?null:(0,s.jsx)(`div`,{className:`mt-3 flex flex-wrap items-center justify-end gap-2`,children:e.map(e=>(0,s.jsx)(a,{count:e.events.length,typeName:e.typeName,isPending:n===e.typeId,onAttend:()=>t(e.typeId)},e.typeId))})}var s;function c(){return(c=e((()=>{i(),s=t(),o.__docgenInfo={description:`One "Attend N <type>" button per event type with blanks left (ADR-0021).
