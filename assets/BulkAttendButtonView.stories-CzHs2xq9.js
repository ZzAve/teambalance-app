import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./BulkAttendButtonView-D5manN14.js";var r,i,a,o,s,c,l,u,d,f,p;function m(){return(m=e((()=>{t(),{expect:r,fn:i,within:a}=__STORYBOOK_MODULE_TEST__,o={title:`features/bulk-attend/BulkAttendButtonView`,component:n,args:{count:3,onAttend:i()}},s={args:{count:0},play:async({canvasElement:e})=>{await r(a(e).queryByRole(`button`)).not.toBeInTheDocument()}},c={play:async({canvas:e})=>{await r(e.getByRole(`button`,{name:/Attend 3 events/})).toBeInTheDocument()}},l={args:{count:1},play:async({canvas:e})=>{await r(e.getByRole(`button`,{name:`Attend 1 event`})).toBeInTheDocument()}},u={args:{count:4,typeName:`Training`},play:async({canvas:e})=>{await r(e.getByRole(`button`,{name:`Attend 4 trainings`})).toBeInTheDocument()}},d={args:{isPending:!0},play:async({canvas:e})=>{await r(e.getByRole(`button`,{name:/Attend 3 events/})).toBeDisabled()}},f={parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e,args:t,userEvent:n})=>{await n.click(e.getByRole(`button`,{name:/Attend 3 events/})),await r(t.onAttend).toHaveBeenCalled()}},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    count: 0
  },
  play: async ({
