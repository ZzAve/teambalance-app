import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{n}from"./iframe-xLdGEXpd.js";import{o as r,r as i}from"./event-fixtures-CuRrQuRB.js";import{n as a,t as o}from"./arrow-left-BTIfjlXE.js";import{n as s,t as c}from"./RecurringEventsWizard-CLQNbWug.js";import{n as l,t as u}from"./CreateEntryChooser-Du8UUIVA.js";import{n as d,t as f}from"./x-Bu0-m_rQ.js";import{t as p}from"./jsx-runtime-DeHZSEgm.js";import{n as m,t as h}from"./utils-BTemNN_S.js";import{n as g,t as _}from"./CreateEventForm-fbcCn6UL.js";import{a as v,c as y,i as b,n as x,o as S,r as C,s as w,t as T}from"./dist-DKuACh12.js";var E,D,O,k,A,j,M,N,P;function F(){return(F=t((()=>{E=e(n(),1),y(),d(),m(),D=p(),O=T,k=S,A=E.forwardRef(({className:e,...t},n)=>(0,D.jsx)(v,{ref:n,className:h(`fixed inset-0 z-50 bg-black/40 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0`,e),...t})),A.displayName=`SheetOverlay`,j=E.forwardRef(({className:e,children:t,...n},r)=>(0,D.jsxs)(k,{children:[(0,D.jsx)(A,{}),(0,D.jsxs)(C,{ref:r,className:h(`fixed inset-x-0 bottom-0 z-50 mx-auto flex max-h-[92vh] w-full max-w-xl flex-col overflow-y-auto rounded-t-2xl border border-border/60 bg-background px-5 pb-8 pt-3 shadow-xl duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom`,e),...n,children:[(0,D.jsx)(`div`,{className:`mx-auto mb-3 h-1.5 w-10 shrink-0 rounded-full bg-border`,"aria-hidden":`true`}),t,(0,D.jsxs)(x,{className:`absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring`,children:[(0,D.jsx)(f,{className:`h-4 w-4`}),(0,D.jsx)(`span`,{className:`sr-only`,children:`Close`})]})]})]})),j.displayName=`SheetContent`,M=({className:e,...t})=>(0,D.jsx)(`div`,{className:h(`mb-3 flex flex-col gap-1 text-center`,e),...t}),M.displayName=`SheetHeader`,N=E.forwardRef(({className:e,...t},n)=>(0,D.jsx)(w,{ref:n,className:h(`font-display text-lead font-semibold leading-none tracking-tight`,e),...t})),N.displayName=`SheetTitle`,P=E.forwardRef(({className:e,...t},n)=>(0,D.jsx)(b,{ref:n,className:h(`text-small text-muted-foreground`,e),...t})),P.displayName=`SheetDescription`,A.__docgenInfo={description:``,methods:[],displayName:`SheetOverlay`},j.__docgenInfo={description:``,methods:[],displayName:`SheetContent`},M.__docgenInfo={description:``,methods:[],displayName:`SheetHeader`},N.__docgenInfo={description:``,methods:[],displayName:`SheetTitle`},P.__docgenInfo={description:``,methods:[],displayName:`SheetDescription`}})))()}function I({mode:e,eventTypes:t=[],positions:n=[],season:r,today:i,isCreatingSingle:a,isCreatingRecurring:s,singleError:l,recurringError:d,onBack:f,onChooseSingle:p,onChooseRecurring:m,onSubmitSingle:h,onSubmitRecurring:g}){return(0,L.jsxs)(L.Fragment,{children:[(0,L.jsxs)(`div`,{className:`relative mb-1 flex items-center justify-center`,children:[(e===`single`||e===`recurring`)&&(0,L.jsx)(`button`,{type:`button`,onClick:f,"aria-label":`Back to event type`,className:`absolute left-0 flex h-8 w-8 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-muted`,children:(0,L.jsx)(o,{size:18})}),(0,L.jsx)(N,{children:R[e]})]}),(0,L.jsx)(P,{className:`mb-4`,children:z[e]}),e===`chooser`&&(0,L.jsx)(u,{onSingle:p,onRecurring:m}),e===`single`&&(0,L.jsx)(_,{eventTypes:t,positions:n,isPending:!!a,onSubmit:h,error:l}),e===`recurring`&&(0,L.jsx)(c,{eventTypes:t,season:r,isPending:!!s,errorMessage:d,today:i,onSubmit:g})]})}var L,R,z;function B(){return(B=t((()=>{a(),F(),g(),s(),l(),L=p(),R={chooser:`Create event`,single:`New event`,recurring:`New recurring series`},z={chooser:`Choose how you want to add events`,single:`A one-off training, match, or other event`,recurring:`A weekly or bi-weekly series across the season`},I.__docgenInfo={description:`Presentational body of the create-event sheet: the mode-dependent header (back step + title +
