import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-xLdGEXpd.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./button-CmeF9f-4.js";import{n as a,t as o}from"./input-D5a5PVWS.js";import{n as s,t as c}from"./label-CRMRXejn.js";import{n as l,t as u}from"./teams-DLysQvyn.js";function d(e){return e.length===0?`Choose a team address.`:e.length>58?`Use 58 characters or fewer.`:f.test(e)?null:`Use lowercase letters, numbers, and hyphens.`}var f;function p(){return(p=e((()=>{f=/^[a-z0-9]+(-[a-z0-9]+)*$/})))()}function m(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``).slice(0,58).replace(/-+$/g,``)}function h(){return(h=e((()=>{p()})))()}function g({isPending:e,error:t,onSubmit:n,reassuranceDelayMs:r=5e3}){let[a,s]=(0,_.useState)(``),[l,u]=(0,_.useState)(``),[f,p]=(0,_.useState)(!1),[h,g]=(0,_.useState)(``),[y,b]=(0,_.useState)(!1),x=e=>{s(e),f||u(m(e))};(0,_.useEffect)(()=>{if(!e)return;let t=setTimeout(()=>b(!0),r);return()=>{clearTimeout(t),b(!1)}},[e,r]);let S=l.length>0?d(l):null,C=a.trim().length>0&&h.trim().length>0&&S===null&&l.length>0&&!e,w=e=>{e.preventDefault(),C&&n({name:a.trim(),slug:l,creationCode:h.trim()})},T=(...e)=>t&&e.includes(t.code)?t.message:null,E=T(`INVALID_NAME`),D=T(`INVALID_SLUG`,`SLUG_TAKEN`)??S,O=T(`INVALID_CREATION_CODE`),k=T(`GENERIC`);return(0,v.jsxs)(`form`,{onSubmit:w,className:`flex flex-col gap-4`,children:[k&&(0,v.jsx)(`p`,{role:`alert`,className:`text-small text-destructive`,children:k}),(0,v.jsxs)(`div`,{children:[(0,v.jsx)(c,{htmlFor:`team-name`,children:`Team name`}),(0,v.jsx)(o,{id:`team-name`,value:a,disabled:e,onChange:e=>x(e.target.value),placeholder:`e.g. Tovo Heren 4`}),E&&(0,v.jsx)(`p`,{className:`mt-1 text-small text-destructive`,children:E})]}),(0,v.jsxs)(`div`,{children:[(0,v.jsx)(c,{htmlFor:`team-slug`,children:`Team address`}),(0,v.jsx)(o,{id:`team-slug`,value:l,disabled:e,onChange:e=>{u(e.target.value),p(!0)},placeholder:`tovo-heren-4`}),D&&(0,v.jsx)(`p`,{className:`mt-1 text-small text-destructive`,children:D})]}),(0,v.jsxs)(`div`,{children:[(0,v.jsx)(c,{htmlFor:`creation-code`,children:`Creation code`}),(0,v.jsx)(o,{id:`creation-code`,value:h,disabled:e,onChange:e=>g(e.target.value),placeholder:`Enter your creation code`}),O&&(0,v.jsx)(`p`,{className:`mt-1 text-small text-destructive`,children:O})]}),(0,v.jsx)(i,{type:`submit`,disabled:!C,children:e?`Creating your team…`:`Create team`}),e&&y&&(0,v.jsx)(`p`,{className:`text-small text-muted-foreground`,children:`Setting up your team's space — this can take a few seconds…`})]})}var _,v;function y(){return(y=e((()=>{_=t(),r(),a(),s(),h(),p(),v=n(),g.__docgenInfo={description:`Presentational create-team form (#158). Prop-only (isPending / error / onSubmit) so every state is a
