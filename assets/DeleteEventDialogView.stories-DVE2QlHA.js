import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-ByyS7Yi9.js";import{a as n,r}from"./event-fixtures-CuRrQuRB.js";import{n as i,t as a}from"./SeriesScopeField-DmlgTRBs.js";import{t as o}from"./jsx-runtime-DeHZSEgm.js";import{n as s,t as c}from"./button-BNHeYByf.js";import{i as l,s as u}from"./dialog-D6E64Zuo.js";function d({eventId:e,siblings:t=[],isPending:n,isError:r,onDelete:i,onCancel:o}){let s=t.length>1,[u,d]=(0,f.useState)(`THIS`);return(0,p.jsxs)(p.Fragment,{children:[s&&(0,p.jsx)(a,{siblings:t,currentId:e,scope:u,onScopeChange:d,variant:`delete`}),r&&(0,p.jsx)(`p`,{className:`rounded-lg border border-red/40 bg-red/10 px-3 py-2 text-small text-red`,children:`Could not delete the event. Please try again.`}),(0,p.jsxs)(l,{children:[(0,p.jsx)(c,{variant:`outline`,onClick:o,disabled:n,children:`Cancel`}),(0,p.jsx)(c,{variant:`destructive`,onClick:()=>i(u),disabled:n,children:n?`Deleting…`:s&&u!==`THIS`?`Delete events`:`Delete event`})]})]})}var f,p;function m(){return(m=e((()=>{f=t(),u(),s(),i(),p=o(),d.__docgenInfo={description:`Presentational body of the delete-event dialog. Owns the local scope state and hands the chosen
