import{i as e,s as t}from"./preload-helper-BdFrVu1K.js";import{t as n}from"./iframe-BXclvPvy.js";import{t as r}from"./jsx-runtime-f3rHp9ZU.js";import{n as i,t as a}from"./button-BHtExP71.js";import{n as o,t as s}from"./input-BSXte1aw.js";import{n as c,t as l}from"./PositionPicker-BR_A8rsr.js";import{a as u,i as d,n as f,o as p,r as m,s as h,t as g}from"./dialog-BnhaMy3m.js";function _(e,t){let n=e.filter(e=>e.role===`ADMIN`);return n.length===1&&n[0].userId===t}var v=e((()=>{}));function y({members:e=[],positions:t,isLoading:n,isError:r,savingUserId:i,errorMessage:o,onRename:s,onToggleRole:c,onChangePosition:l,onRemove:h}){let[v,y]=(0,x.useState)(null);return(0,S.jsxs)(`div`,{children:[(0,S.jsx)(`h2`,{className:`font-display text-2xl font-bold`,children:`Members`}),n&&(0,S.jsx)(`p`,{className:`mt-4 text-sm text-muted-foreground`,children:`Loading…`}),r&&(0,S.jsx)(`p`,{className:`mt-4 text-sm text-red-500`,children:`Couldn't load members. Please try again.`}),!n&&!r&&(0,S.jsxs)(`div`,{className:`mt-4 flex flex-col gap-3`,children:[o&&(0,S.jsx)(`p`,{role:`alert`,className:`rounded-md bg-red-50 px-3 py-2 text-sm text-red-600`,children:o}),(0,S.jsx)(`ul`,{className:`divide-y divide-border rounded-lg border border-border`,children:e.map(n=>(0,S.jsx)(b,{member:n,positions:t,lastAdmin:_(e,n.userId),isSaving:i===n.userId,onRename:s,onToggleRole:c,onChangePosition:l,onRequestRemove:y},n.userId))}),(0,S.jsx)(g,{open:v!==null,onOpenChange:e=>{e||y(null)},children:(0,S.jsxs)(f,{children:[(0,S.jsxs)(u,{children:[(0,S.jsx)(p,{children:`Remove member`}),(0,S.jsxs)(m,{children:[`Remove `,v?.displayName,` from the team? They will lose access until re-invited.`]})]}),(0,S.jsxs)(d,{children:[(0,S.jsx)(a,{variant:`outline`,onClick:()=>y(null),children:`Cancel`}),(0,S.jsx)(a,{variant:`destructive`,onClick:()=>{v&&h(v),y(null)},children:`Remove`})]})]})})]})]})}function b({member:e,positions:t,lastAdmin:n,isSaving:r,onRename:i,onToggleRole:o,onChangePosition:c,onRequestRemove:u}){let[d,f]=(0,x.useState)(e.displayName),p=e.role===`ADMIN`,m=d.trim().length>0&&d.trim()!==e.displayName,h=n?`This is the last admin — the team must keep at least one.`:void 0;return(0,S.jsxs)(`li`,{className:`flex flex-wrap items-center gap-2 p-3`,children:[(0,S.jsx)(s,{"aria-label":`Display name for ${e.displayName}`,value:d,onChange:e=>f(e.target.value),className:`w-40`}),m&&(0,S.jsx)(a,{size:`sm`,disabled:r,onClick:()=>i(e.userId,d.trim()),children:r?`Saving...`:`Save`}),t.length>0?(0,S.jsx)(`div`,{className:`w-44`,children:(0,S.jsx)(l,{"aria-label":`Position for ${e.displayName}`,positions:t,value:e.position?.id??null,includeUnassigned:!0,disabled:r,onChange:t=>c(e,t)})}):(0,S.jsx)(`span`,{className:`text-sm text-muted-foreground`,children:e.position?.label??`Unassigned`}),(0,S.jsx)(`span`,{className:[`ml-auto rounded-full px-2 py-0.5 text-xs font-semibold`,p?`bg-blue/10 text-blue`:`bg-muted text-muted-foreground`].join(` `),children:e.role}),(0,S.jsx)(a,{variant:`outline`,size:`sm`,disabled:r,title:p?h:void 0,onClick:()=>o(e),children:p?`Make member`:`Make admin`}),(0,S.jsx)(a,{variant:`destructive`,size:`sm`,disabled:r,title:h,onClick:()=>u(e),children:`Remove`})]})}var x,S,C=e((()=>{x=t(n(),1),c(),i(),o(),h(),v(),S=r(),y.__docgenInfo={description:`Presentational admin roster — the complete section, heading and all. Owns only local view state
