import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,r as n,s as r,t as i}from"./event-fixtures-CuRrQuRB.js";import{n as a,t as o}from"./check-BgODOozf.js";import{i as s,n as c,r as l,t as u}from"./map-pin-V7VVu6QK.js";import{n as d,t as f}from"./x-CpzqL8Ls.js";import{t as p}from"./jsx-runtime-DeHZSEgm.js";import{n as ee,t as te}from"./ReadinessBadge-CIkCObA2.js";import{i as ne,n as re,r as m,t as h}from"./router-decorator-B2uHYZwn.js";import{a as g,n as _}from"./team-routes-B8XEfCF2.js";import{n as v,t as y}from"./modes-Bzyminl_.js";function b(e,t){let n=(e instanceof Date?e:new Date(e)).getTime()-t.getTime();return n<=0?{value:`Now`,unit:`on`}:n>=C?{value:`${Math.floor(n/C)}d`,unit:`away`}:n>=S?{value:`${Math.floor(n/S)}h`,unit:`away`}:{value:`${Math.max(1,Math.floor(n/x))}m`,unit:`away`}}var x,S,C;function w(){return(w=e((()=>{x=6e4,S=60*x,C=24*S})))()}function T({event:e,myState:t,isSaving:n=!1,onRespond:r,now:i=new Date}){let a=g(),s=new Date(e.startTime),c=b(e.startTime,i),d=t===`ATTENDING`,p=t===`ABSENT`;return(0,E.jsxs)(`section`,{"aria-label":`Next up`,className:`relative mt-4 overflow-hidden rounded-3xl p-4 text-white`,style:{background:`linear-gradient(135deg, var(--color-green) 0%, var(--color-green-dark) 100%)`,boxShadow:`0 14px 34px rgba(34, 92, 156, 0.18)`},children:[(0,E.jsx)(`span`,{"aria-hidden":`true`,className:`pointer-events-none absolute -right-8 -top-10 h-[150px] w-[150px] rounded-full bg-white/15 blur-sm`}),(0,E.jsxs)(`div`,{className:`pointer-events-none absolute right-4 top-4 z-10 text-right`,children:[(0,E.jsx)(`span`,{className:`font-display block text-[22px] font-extrabold leading-none`,children:c.value}),(0,E.jsx)(`span`,{className:`text-[10px] uppercase tracking-[0.08em] opacity-85`,children:c.unit})]}),(0,E.jsx)(`p`,{className:`pr-12 text-[11px] font-bold uppercase tracking-[0.14em] text-white/90`,children:`Next up`}),(0,E.jsx)(`h3`,{className:`font-display mb-1 mt-2 pr-12 text-[21px] font-extrabold leading-[1.08]`,children:(0,E.jsx)(m,{to:a.event(e.id),className:`after:absolute after:inset-0 after:rounded-3xl after:bg-white/0 after:transition-colors after:duration-200 hover:underline hover:after:bg-white/[0.07] focus-visible:outline-none focus-visible:after:ring-2 focus-visible:after:ring-inset focus-visible:after:ring-white`,children:e.title})}),(0,E.jsxs)(`p`,{className:`flex flex-wrap items-center gap-1.5 text-[13px] text-white/95`,children:[(0,E.jsx)(l,{size:13,className:`shrink-0`}),s.toLocaleDateString(`nl-NL`,{weekday:`short`,day:`numeric`,month:`short`}),` · `,s.toLocaleTimeString(`nl-NL`,{hour:`2-digit`,minute:`2-digit`})]}),e.location&&(0,E.jsxs)(`p`,{className:`mt-1 flex flex-wrap items-center gap-1.5 text-[13px] text-white/95`,children:[(0,E.jsx)(u,{size:13,className:`shrink-0`}),(0,E.jsx)(`a`,{href:`https://maps.google.com/?q=${encodeURIComponent(e.location)}`,target:`_blank`,rel:`noopener noreferrer`,className:`relative z-10 underline decoration-white/30 underline-offset-2 transition-colors hover:decoration-white`,children:e.location})]}),(0,E.jsxs)(`div`,{className:`mt-2.5 flex items-center justify-between gap-2`,children:[(0,E.jsxs)(`p`,{className:`text-[13px] text-white/90`,children:[e.attendanceSummary.attending,` going · `,D[t]]}),(0,E.jsx)(te,{roster:e.roster,variant:`hero`,pending:n})]}),(0,E.jsxs)(`div`,{className:`relative z-10 mt-3.5 flex gap-2`,children:[(0,E.jsxs)(`button`,{"aria-pressed":d,disabled:n,onClick:()=>r(`ATTENDING`),style:p?void 0:{color:`var(--color-green-dark)`},className:[`flex flex-1 items-center justify-center gap-1.5 rounded-xl py-2.5 text-[13.5px] font-bold transition-all active:scale-95`,p?`bg-white/20 text-white`:`bg-white`,n?`cursor-not-allowed opacity-60`:`cursor-pointer`].join(` `),children:[(0,E.jsx)(o,{size:16}),`I'm in`]}),(0,E.jsxs)(`button`,{"aria-pressed":p,disabled:n,onClick:()=>r(`ABSENT`),style:p?{color:`var(--color-red)`}:void 0,className:[`flex flex-1 items-center justify-center gap-1.5 rounded-xl py-2.5 text-[13.5px] font-bold transition-all active:scale-95`,p?`bg-white`:d?`bg-white/12 text-white`:`bg-white/20 text-white`,n?`cursor-not-allowed opacity-60`:`cursor-pointer`].join(` `),children:[(0,E.jsx)(f,{size:16}),`Can't make it`]})]})]})}var E,D;function O(){return(O=e((()=>{ne(),a(),s(),c(),d(),ee(),w(),_(),E=p(),D={ATTENDING:`you're in`,ABSENT:`you're out`,MAYBE:`you said maybe`,NOT_RESPONDED:`you haven't responded`},T.__docgenInfo={description:`The Next Up hero: the most imminent event, big, with its countdown and an inline RSVP so the
