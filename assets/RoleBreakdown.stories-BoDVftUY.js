import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";function n({breakdown:e}){return e.length===0?null:(0,r.jsx)(`div`,{className:`flex flex-wrap gap-1.5 px-3 py-2`,children:e.map(({role:e,attending:t})=>(0,r.jsxs)(`span`,{className:`rounded-full bg-green/10 px-2.5 py-1 text-caption font-medium text-green`,children:[t,` `,e]},e))})}var r;function i(){return(i=e((()=>{r=t(),n.__docgenInfo={description:`Presentational breakdown of attending members grouped by role, rendered as chips.
