...
caught up with the card: the card said "4 more needed", you tapped through, and the number was gone.`,methods:[],displayName:`RosterBar`,props:{roster:{required:!0,tsType:{name:`EventRoster`},description:``}}}})))()}var f,p,m,h,g,_,v,y,b,x,S,C,w;function T(){return(T=e((()=>{n(),d(),f=o(),{expect:p}=__STORYBOOK_MODULE_TEST__,m={title:`entities/event/RosterBar`,component:s,args:{roster:t()},decorators:[e=>(0,f.jsx)(`div`,{className:`max-w-md`,children:(0,f.jsx)(e,{})})]},h={play:async({canvas:e})=>{await p(e.getByText(/4\/5 spots/)).toBeInTheDocument(),await p(e.getByText(/1 spot open/)).toBeInTheDocument(),await p(e.getByText(/Middle 1\/2/)).toBeInTheDocument()}},g={args:{roster:t({positions:[{id:`pos-setter`,label:`Setter`,required:2,attending:2,kind:`PLAYING`},{id:`pos-middle`,label:`Middle`,required:2,attending:0,kind:`PLAYING`}],state:`CRITICAL`})},play:async({canvas:e})=>{await p(e.getByText(/Missing a position/)).toBeInTheDocument(),await p(e.getByText(/Middle 0\/2/)).toBeInTheDocument()}},_={args:{roster:t({positions:[{id:`pos-setter`,label:`Setter`,required:2,attending:2,kind:`PLAYING`},{id:`pos-libero`,label:`Libero`,required:1,attending:1,kind:`PLAYING`}],state:`LINEUP_SET`})},play:async({canvas:e})=>{await p(e.getByText(/3\/3 spots/)).toBeInTheDocument(),await p(e.getByText(/Lineup set/)).toBeInTheDocument()}},v={args:{roster:t({positions:[],totalTarget:12,totalAttending:8,openSlots:4,state:`HEADCOUNT_SHORT`})},play:async({canvas:e})=>{await p(e.getByText(/8\/12 going/)).toBeInTheDocument(),await p(e.getByText(/4 more needed/)).toBeInTheDocument()}},y={args:{roster:t({positions:[],totalTarget:12,totalAttending:12,openSlots:0,state:`HEADCOUNT_FULL`})},play:async({canvas:e})=>{await p(e.getByText(/12\/12 going/)).toBeInTheDocument(),await p(e.getByText(/Full/)).toBeInTheDocument()}},b={args:{roster:t({positions:[],totalTarget:void 0,totalAttending:8,openSlots:0,state:`TALLY_ONLY`})},play:async({canvas:e,canvasElement:t})=>{await p(e.getByText(/8 going/)).toBeInTheDocument(),await p(e.queryByText(/\//)).not.toBeInTheDocument(),await p(t.querySelector(`[data-slot="roster-track"]`)).toBeNull()}},x={args:{roster:t({trackRoster:!1,positions:[],totalTarget:void 0,totalAttending:8,openSlots:0,state:`OFF`})},play:async({canvasElement:e})=>{await p(e.querySelector(`div`)?.textContent??``).toBe(``)}},S={args:{roster:t({state:`HEADCOUNT_SHORT`,openSlots:1,totalTarget:12,totalAttending:12,positions:[{id:`pos-setter`,label:`Setter`,required:void 0,attending:11,kind:`PLAYING`},{id:`pos-trainer`,label:`Trainer`,required:void 0,attending:1,kind:`STAFF`}]})},play:async({canvas:e})=>{await p(e.getByText(/11\/12 going \+1 staff/)).toBeInTheDocument(),await p(e.getByText(/1 more needed/)).toBeInTheDocument()}},C={args:{roster:t({state:`HEADCOUNT_FULL`,openSlots:0,totalTarget:12,totalAttending:12,positions:[{id:`pos-setter`,label:`Setter`,required:void 0,attending:11,kind:`PLAYING`},{id:`pos-trainer`,label:`Trainer`,required:void 0,attending:1,kind:`PLAYING`}]})},play:async({canvas:e})=>{await p(e.getByText(/12\/12 going/)).toBeInTheDocument(),await p(e.getByText(/Full/)).toBeInTheDocument(),await p(e.queryByText(/staff/)).not.toBeInTheDocument()}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvas
  }) => {
