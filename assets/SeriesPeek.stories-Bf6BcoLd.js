import{i as e,s as t}from"./preload-helper-BdFrVu1K.js";import{t as n}from"./iframe-gVcGreIy.js";import{i as r,n as i,r as a,t as o}from"./router-decorator-FOzLtNzo.js";import{t as s}from"./jsx-runtime-f3rHp9ZU.js";import{n as c,t as l}from"./event-fixtures-CKCzWaqm.js";import{P as u,g as d,t as f}from"./lucide-react-Cc4aLrJ7.js";function p(e,t){if(e.length<2)return null;let n=[...e].sort((e,t)=>e.startTime.localeCompare(t.startTime)),r=n.findIndex(e=>e.id===t);if(r===-1)return null;let i=e=>({id:e.id,startTime:e.startTime,isCurrent:e.id===t});return n.length<=4?{total:n.length,currentPosition:r+1,head:n.map(i),tail:[],hiddenCount:0}:{total:n.length,currentPosition:r+1,head:n.slice(0,m).map(i),tail:n.slice(n.length-h).map(i),hiddenCount:n.length-m-h}}var m,h,g=e((()=>{m=2,h=2}));function _(e){return new Date(e).toLocaleDateString(`nl-NL`,{weekday:`short`,day:`numeric`,month:`short`,year:`numeric`})}function v({entry:e}){let t=_(e.startTime),n=(0,x.jsxs)(`div`,{className:[`flex items-center gap-2.5 rounded-lg px-2.5 py-1.5 text-sm tabular-nums transition-colors`,e.isCurrent?`bg-blue/10 font-semibold text-foreground`:`text-muted-foreground hover:bg-muted/60`].join(` `),children:[(0,x.jsx)(`span`,{className:`h-2 w-2 shrink-0 rounded-full ${e.isCurrent?`bg-blue`:`bg-blue/40`}`}),t,e.isCurrent&&(0,x.jsx)(`span`,{className:`ml-auto rounded-full bg-blue/15 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-blue`,children:`This one`})]});return e.isCurrent?n:(0,x.jsx)(r,{to:`/events/$eventId`,params:{eventId:e.id},children:n})}function y({peek:e}){let[t,n]=(0,b.useState)(!1);return(0,x.jsxs)(`div`,{className:`mt-6 rounded-2xl border border-blue/15 bg-blue/5 p-4`,children:[(0,x.jsxs)(`button`,{type:`button`,onClick:()=>n(e=>!e),"aria-expanded":t,className:`flex w-full items-center gap-2 text-left`,children:[(0,x.jsx)(`span`,{className:`flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-blue/10 text-blue`,children:(0,x.jsx)(d,{size:15})}),(0,x.jsxs)(`div`,{className:`min-w-0`,children:[(0,x.jsx)(`p`,{className:`text-sm font-bold leading-tight`,children:`Part of a series`}),(0,x.jsxs)(`p`,{className:`text-xs text-muted-foreground`,children:[`Occurrence `,e.currentPosition,` of `,e.total]})]}),(0,x.jsx)(u,{size:18,className:`ml-auto shrink-0 text-muted-foreground transition-transform ${t?`rotate-180`:``}`})]}),t&&(0,x.jsxs)(`div`,{className:`mt-3 flex flex-col gap-1`,children:[e.head.map(e=>(0,x.jsx)(v,{entry:e},e.id)),e.hiddenCount>0&&(0,x.jsxs)(`div`,{className:`flex items-center gap-2 px-2.5 py-1 text-xs italic text-muted-foreground`,children:[(0,x.jsx)(`span`,{className:`h-px flex-1 bg-border`}),`+`,e.hiddenCount,` more`,(0,x.jsx)(`span`,{className:`h-px flex-1 bg-border`})]}),e.tail.map(e=>(0,x.jsx)(v,{entry:e},e.id))]})]})}var b,x,S=e((()=>{b=t(n(),1),a(),f(),x=s(),y.__docgenInfo={description:`A "part of a series" disclosure on the event-detail route (ADR-0014). The membership line is
...
}`,...k.parameters?.docs?.source}}},A=[`CollapsedByDefault`,`ExpandedLongSeries`,`CurrentInHead`,`ShortSeries`]}))();export{E as CollapsedByDefault,O as CurrentInHead,D as ExpandedLongSeries,k as ShortSeries,A as __namedExportsOrder,w as default};