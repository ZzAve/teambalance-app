import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./createLucideIcon-BV1UoinF.js";import{n as r,t as i}from"./check-B45NDyuy.js";import{n as a,t as o}from"./circle-plus-CozIHs0B.js";import{n as s,t as c}from"./users-BBSF9C3C.js";import{t as l}from"./jsx-runtime-DeHZSEgm.js";var u,d;function f(){return(f=e((()=>{t(),u=[[`path`,{d:`M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z`,key:`qn84l0`}],[`path`,{d:`M13 5v2`,key:`dyzc3o`}],[`path`,{d:`M13 17v2`,key:`1ont0d`}],[`path`,{d:`M13 11v2`,key:`1wjjxi`}]],d=n(`ticket`,u)})))()}function p({children:e}){return(0,h.jsx)(`h2`,{className:`mb-2 px-1 text-sm font-semibold text-muted-foreground`,children:e})}function m({teams:e,activeTeam:t,onSelect:n,onJoin:r,onCreate:a}){return(0,h.jsxs)(`div`,{className:`mx-auto mt-10 max-w-sm`,children:[(0,h.jsx)(`h1`,{className:`font-display text-2xl font-bold`,children:`Teams`}),(0,h.jsxs)(`section`,{className:`mt-6`,children:[(0,h.jsx)(p,{children:`Your teams`}),(0,h.jsx)(`ul`,{className:`flex flex-col gap-2`,children:e.map(e=>{let r=e.id===t?.id;return(0,h.jsx)(`li`,{children:(0,h.jsxs)(`button`,{type:`button`,onClick:()=>n(e.slug),"aria-current":r?`true`:void 0,className:`flex w-full items-center gap-3 rounded-2xl border border-border/60 bg-card px-4 py-4 text-left transition-colors hover:border-blue/40 hover:bg-blue/5`,children:[(0,h.jsx)(`span`,{className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue/10 text-blue`,children:(0,h.jsx)(c,{size:18})}),(0,h.jsxs)(`span`,{className:`min-w-0`,children:[(0,h.jsx)(`span`,{className:`block truncate text-sm font-semibold`,children:e.name}),(0,h.jsxs)(`span`,{className:`block truncate text-xs text-muted-foreground`,children:[`/`,e.slug]})]}),r&&(0,h.jsxs)(`span`,{className:`ml-auto flex shrink-0 items-center gap-1 rounded-full bg-green/10 px-2 py-0.5 text-xs font-semibold text-green`,children:[(0,h.jsx)(i,{size:13}),`Active`]})]})},e.id)})})]}),(0,h.jsxs)(`section`,{className:`mt-8 border-t border-border pt-6`,children:[(0,h.jsx)(p,{children:`Join or create`}),(0,h.jsxs)(`div`,{className:`flex flex-col gap-2`,children:[(0,h.jsxs)(`button`,{type:`button`,onClick:r,className:`flex w-full items-center gap-3 rounded-2xl border border-border/60 bg-card px-4 py-4 text-left transition-colors hover:border-blue/40 hover:bg-blue/5`,children:[(0,h.jsx)(`span`,{className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue/10 text-blue`,children:(0,h.jsx)(d,{size:18})}),(0,h.jsxs)(`span`,{className:`min-w-0`,children:[(0,h.jsx)(`span`,{className:`block text-sm font-semibold`,children:`Join with an invite link`}),(0,h.jsx)(`span`,{className:`block truncate text-xs text-muted-foreground`,children:`Someone shared a join link with you`})]})]}),(0,h.jsxs)(`button`,{type:`button`,onClick:a,className:`flex w-full items-center gap-3 rounded-2xl border border-border/60 bg-card px-4 py-4 text-left transition-colors hover:border-blue/40 hover:bg-blue/5`,children:[(0,h.jsx)(`span`,{className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue/10 text-blue`,children:(0,h.jsx)(o,{size:18})}),(0,h.jsxs)(`span`,{className:`min-w-0`,children:[(0,h.jsx)(`span`,{className:`block text-sm font-semibold`,children:`Create a team`}),(0,h.jsx)(`span`,{className:`block truncate text-xs text-muted-foreground`,children:`You'll need a creation code`})]})]})]})]})]})}var h;function g(){return(g=e((()=>{r(),a(),f(),s(),h=l(),m.__docgenInfo={description:`The Teams "main view" (ADR-0027 §4): the fuller entry point the Account tab's Teams row opens.
