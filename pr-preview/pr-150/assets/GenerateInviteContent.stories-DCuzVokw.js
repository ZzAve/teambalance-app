import{i as e}from"./preload-helper-BdFrVu1K.js";import{t}from"./jsx-runtime-f3rHp9ZU.js";import{i as n,n as r,r as i,t as a}from"./input-n3IZEKWy.js";function o({isPending:e,isError:t,link:n,copied:r,expired:o,isRotating:c,isExpiring:l,actionError:u,onCopy:d,onRotate:f,onExpire:p,onGenerateNew:m}){return e?(0,s.jsx)(`p`,{className:`text-muted-foreground`,children:`Generating...`}):t?(0,s.jsx)(`p`,{className:`text-destructive`,children:`Failed to generate invite link.`}):n?o?(0,s.jsxs)(`div`,{className:`flex flex-col gap-3`,children:[(0,s.jsx)(`p`,{className:`text-sm text-muted-foreground`,children:`This link has expired. New joiners can no longer use it.`}),(0,s.jsx)(i,{type:`button`,onClick:m,children:`Generate new link`})]}):(0,s.jsxs)(`div`,{className:`flex flex-col gap-3`,children:[(0,s.jsx)(`p`,{className:`text-sm text-muted-foreground`,children:`Share this link with your team. Anyone with the link can join.`}),(0,s.jsxs)(`div`,{className:`flex gap-2`,children:[(0,s.jsx)(a,{readOnly:!0,value:n,onFocus:e=>e.currentTarget.select()}),(0,s.jsx)(i,{type:`button`,onClick:d,children:r?`Copied!`:`Copy`})]}),(0,s.jsxs)(`div`,{className:`flex gap-2`,children:[(0,s.jsx)(i,{type:`button`,variant:`outline`,onClick:f,disabled:c,children:c?`Rotating...`:`Rotate link`}),(0,s.jsx)(i,{type:`button`,variant:`destructive`,onClick:p,disabled:l,children:l?`Expiring...`:`Expire link`})]}),u&&(0,s.jsx)(`p`,{className:`text-sm text-destructive`,children:`Something went wrong. Please try again.`})]}):null}var s,c=e((()=>{n(),r(),s=t(),o.__docgenInfo={description:`Presentational body of the invite dialog. Renders exactly one of: generating / error / expired /
