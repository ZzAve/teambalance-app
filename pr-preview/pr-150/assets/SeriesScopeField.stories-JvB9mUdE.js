import{i as e,s as t}from"./preload-helper-BdFrVu1K.js";import{t as n}from"./iframe-MJ8FevkI.js";import{t as r}from"./jsx-runtime-f3rHp9ZU.js";import{n as i,t as a}from"./event-fixtures-CKCzWaqm.js";import{m as o,t as s,w as c}from"./lucide-react-Cz1dTPut.js";function l(e,t,n){switch(e){case`THIS`:return[t,t];case`THIS_AND_FOLLOWING`:return[t,n-1];case`ALL`:return[0,n-1]}}function u(e,t,n){let r=[...e].sort((e,t)=>e.startTime.localeCompare(t.startTime)),i=r.findIndex(e=>e.id===t);if(i===-1)return null;let[a,o]=l(n,i,r.length);return{scope:n,nodes:r.map((e,t)=>({id:e.id,startTime:e.startTime,affected:t>=a&&t<=o,isCurrent:t===i})),affectedCount:o-a+1,total:r.length}}var d=e((()=>{}));function f(e){return new Date(e).toLocaleDateString(`nl-NL`,{day:`numeric`,month:`short`})}function p({siblings:e,currentId:t,scope:n,onScopeChange:r,variant:i=`edit`}){let a=u(e,t,n);if(!a)return null;let s=i===`delete`,l=s?`Removes`:`Affects`,d=s?v[n]:_[n],f=s?`border-red-500/20 bg-red-500/5`:`border-blue/20 bg-blue/5`,p=s?`text-red-500`:`text-blue`;return(0,h.jsxs)(`div`,{className:`flex flex-col gap-3`,children:[(0,h.jsxs)(`div`,{children:[(0,h.jsx)(`p`,{className:`mb-1.5 text-xs font-semibold uppercase tracking-widest text-muted-foreground`,children:s?`Delete`:`Apply to`}),(0,h.jsx)(`div`,{role:`group`,"aria-label":`Scope`,className:`flex gap-1.5`,children:g.map(({value:e,label:t})=>{let i=n===e;return(0,h.jsx)(`button`,{type:`button`,"aria-pressed":i,onClick:()=>r(e),className:[`flex-1 rounded-lg border px-2 py-2 text-xs font-semibold transition-colors`,i?s?`border-red-500 bg-red-500 text-white`:`border-blue bg-blue text-white`:`border-border text-muted-foreground hover:bg-muted/60`].join(` `),children:t},e)})})]}),(0,h.jsxs)(`div`,{className:`rounded-xl border p-3 ${f}`,children:[(0,h.jsxs)(`p`,{className:`text-sm font-bold ${p}`,children:[l,` `,a.affectedCount,` of `,a.total,` event`,a.total===1?``:`s`]}),(0,h.jsx)(m,{preview:a,danger:s}),(0,h.jsxs)(`p`,{className:`mt-2.5 flex items-start gap-1.5 text-xs text-muted-foreground`,children:[(0,h.jsx)(o,{size:13,className:`mt-0.5 shrink-0`}),(0,h.jsx)(`span`,{children:d})]})]}),!s&&n!==`THIS`&&(0,h.jsxs)(`p`,{className:`flex items-start gap-1.5 rounded-lg bg-muted/60 px-3 py-2 text-xs text-muted-foreground`,children:[(0,h.jsx)(c,{size:13,className:`mt-0.5 shrink-0`}),(0,h.jsx)(`span`,{children:`Each occurrence keeps its own date; the time & details apply to all affected events.`})]})]})}function m({preview:e,danger:t}){let n=t?`bg-red-500`:`bg-blue`;return(0,h.jsx)(`div`,{className:`mt-2 flex items-center gap-1`,"aria-hidden":`true`,children:e.nodes.map((r,i)=>{let a=e.nodes[i-1];return(0,h.jsxs)(`div`,{className:`flex items-center gap-1`,children:[a&&a.affected!==r.affected&&(0,h.jsx)(`span`,{className:`h-4 w-px shrink-0 bg-border`,"data-testid":`split-marker`}),(0,h.jsx)(`span`,{title:f(r.startTime),className:[`h-2.5 w-2.5 rounded-full transition-colors`,r.affected?n:`bg-border`,r.isCurrent?t?`ring-2 ring-red-500/40`:`ring-2 ring-blue/40`:``].join(` `)})]},r.id)})})}var h,g,_,v,y=e((()=>{s(),d(),h=r(),g=[{value:`THIS`,label:`This event`},{value:`THIS_AND_FOLLOWING`,label:`This & following`},{value:`ALL`,label:`All events`}],_={THIS:`Splits the series into three: everything before, this one on its own (its date can move), and everything after — each independent.`,THIS_AND_FOLLOWING:`Splits the series in two: occurrences before stay as they are; this one and every later one become a new series with the edited details.`,ALL:`No split — the edit applies to every occurrence in the one series.`},v={THIS:`Removes just this occurrence; the rest of the series stays.`,THIS_AND_FOLLOWING:`Removes this occurrence and every later one; the earlier ones stay as a shorter series.`,ALL:`Removes the entire series.`},p.__docgenInfo={description:`The scope selector + live affected-preview shown when editing or deleting one occurrence of a
...
}`,...M.parameters?.docs?.source}}},N=[`EditThis`,`EditThisAndFollowing`,`EditAll`,`DeleteThis`,`DeleteThisAndFollowing`,`DeleteAll`]}))();export{M as DeleteAll,A as DeleteThis,j as DeleteThisAndFollowing,k as EditAll,D as EditThis,O as EditThisAndFollowing,N as __namedExportsOrder,E as default};