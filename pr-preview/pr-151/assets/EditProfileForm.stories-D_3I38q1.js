import{i as e,s as t}from"./preload-helper-BdFrVu1K.js";import{t as n}from"./iframe-BOS77XOy.js";import{t as r}from"./jsx-runtime-f3rHp9ZU.js";import{n as i,t as a}from"./button-DDSktX6Q.js";import{n as o,t as s}from"./input-3VPjnkik.js";import{n as c,t as l}from"./label-Di9cSEfm.js";import{n as u,t as d}from"./PositionPicker-ceg91cU1.js";function f(e){let t=e.trim();return t.length===0?`Display name is required.`:t.length>p?`Display name must be ${p} characters or fewer.`:null}var p,m=e((()=>{p=100}));function h(e,t){return e.length===0||t?null:`Please select a position.`}var g=e((()=>{}));function _({currentName:e,positions:t,currentPositionId:n,isSaving:r,onSubmit:i,errorCode:o}){let[c,u]=(0,v.useState)(e),[p,m]=(0,v.useState)(n),[g,_]=(0,v.useState)(!1),b=f(c),x=h(t,p),S=b??x;return(0,y.jsxs)(`form`,{onSubmit:e=>{if(e.preventDefault(),S){_(!0);return}i(c.trim(),p)},className:`flex flex-col gap-4`,children:[(0,y.jsxs)(`div`,{children:[(0,y.jsx)(l,{htmlFor:`displayName`,children:`Display name`}),(0,y.jsx)(s,{id:`displayName`,name:`displayName`,value:c,onChange:e=>{u(e.target.value),_(!0)},"aria-invalid":g&&b?!0:void 0,placeholder:`Your name`}),g&&b&&(0,y.jsx)(`p`,{className:`mt-1 text-sm text-red-500`,children:b}),o===`NAME_TAKEN`&&(0,y.jsx)(`p`,{className:`mt-1 text-sm text-red-500`,children:`That display name is already taken.`})]}),t.length>0&&(0,y.jsxs)(`div`,{children:[(0,y.jsx)(l,{htmlFor:`position`,children:`Position`}),(0,y.jsx)(d,{"aria-label":`Position`,positions:t,value:p,onChange:e=>{m(e),_(!0)}}),g&&x&&(0,y.jsx)(`p`,{className:`mt-1 text-sm text-red-500`,children:x})]}),(0,y.jsx)(a,{type:`submit`,disabled:r||!!S,children:r?`Saving...`:`Save`})]})}var v,y,b=e((()=>{v=t(n(),1),u(),i(),o(),c(),m(),g(),y=r(),_.__docgenInfo={description:`Presentational edit-profile form. Owns only the local field + touched state; the current member
