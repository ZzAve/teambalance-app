import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-ARJhC-h6.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./event-fixtures-zk5yUMAb.js";import{n as a,t as o}from"./SeriesScopeField-BLEKsScq.js";import{n as s,t as c}from"./button-Dlm8NzOv.js";import{i as l,s as u}from"./dialog-2Sz4quh-.js";function d({eventId:e,siblings:t=[],isPending:n,isError:r,onDelete:i,onCancel:a}){let s=t.length>1,[u,d]=(0,f.useState)(`THIS`);return(0,p.jsxs)(p.Fragment,{children:[s&&(0,p.jsx)(o,{siblings:t,currentId:e,scope:u,onScopeChange:d,variant:`delete`}),r&&(0,p.jsx)(`p`,{className:`rounded-lg border border-red-300 bg-red-500/10 px-3 py-2 text-sm text-red-500`,children:`Could not delete the event. Please try again.`}),(0,p.jsxs)(l,{children:[(0,p.jsx)(c,{variant:`outline`,onClick:a,disabled:n,children:`Cancel`}),(0,p.jsx)(c,{variant:`destructive`,onClick:()=>i(u),disabled:n,children:n?`Deleting…`:s&&u!==`THIS`?`Delete events`:`Delete event`})]})]})}var f,p;function m(){return(m=e((()=>{f=t(),u(),s(),a(),p=n(),d.__docgenInfo={description:`Presentational body of the delete-event dialog. Owns the local scope state and hands the chosen
