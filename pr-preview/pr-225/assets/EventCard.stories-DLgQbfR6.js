import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./router-decorator-DBNZvytx.js";import{n as r,t as i}from"./event-fixtures-zk5yUMAb.js";import{n as a,t as o}from"./EventCard-Doz__DK8.js";var s,c,l,u,d,f,p,m,h,g,_,v,y;function b(){return(b=e((()=>{n(),i(),a(),{expect:s}=__STORYBOOK_MODULE_TEST__,c=new Date(2026,7,10,9,0),l=(e,t=20,n=0)=>new Date(2026,7,e,t,n).toISOString(),u={title:`entities/event/EventCard`,component:o,decorators:[t],args:{now:c}},d={args:{event:r({startTime:l(13,14,30),location:`Sportcentrum Noord`})},play:async({canvas:e})=>{await s(e.getByText(`13`)).toBeInTheDocument(),await s(e.getByText(`14:30`)).toBeInTheDocument(),await s(e.getByText(`Match`)).toBeInTheDocument(),await s(e.getByText(/5 going/)).toBeInTheDocument(),await s(e.getByText(/of 8/)).toBeInTheDocument()}},f={args:{event:r({startTime:l(13)})},play:async({canvas:e})=>{await s(e.getByText(`in 3 days`)).toBeInTheDocument()}},p={args:{event:r({startTime:l(11)})},play:async({canvas:e})=>{await s(e.getByText(`Tomorrow`)).toBeInTheDocument()}},m={args:{event:r({startTime:l(31)})},play:async({canvas:e})=>{await s(e.getByText(`31`)).toBeInTheDocument(),await s(e.queryByText(/^in \d+ days$/)).not.toBeInTheDocument(),await s(e.queryByText(/^(Today|Tomorrow|This weekend)$/)).not.toBeInTheDocument()}},h={args:{event:r({eventType:{id:`et-4`,name:`Social`,color:`#F4B400`},title:`Season kick-off drinks`,startTime:l(15,21,0),location:`Café De Hoek`,attendanceSummary:{attending:11,maybe:0,absent:2,notResponded:2,roleBreakdown:[]}})},play:async({canvas:e})=>{await s(e.getByText(`Social`)).toBeInTheDocument(),await s(e.getByText(`Season kick-off drinks`)).toBeInTheDocument(),await s(e.getByText(/11 going/)).toBeInTheDocument(),await s(e.getByText(`This weekend`)).toBeInTheDocument()}},g={args:{event:r({startTime:l(13),attendanceSummary:{attending:0,maybe:0,absent:0,notResponded:0,roleBreakdown:[]}})},play:async({canvas:e})=>{await s(e.getByText(/0 going/)).toBeInTheDocument(),await s(e.getByText(/of 0/)).toBeInTheDocument()}},_={args:{event:r({startTime:l(13),references:[{title:`Nevobo`,url:`https://api.nevobo.nl/permalink/wedstrijd/2018133`},{title:`Match form`,url:`https://dwf.volleybal.nl/match/42`},{title:`Route`,url:`https://maps.example.com/hall`}]})},play:async({canvas:e,canvasElement:t})=>{await s(e.getByRole(`link`,{name:/Nevobo/})).toBeInTheDocument(),await s(e.getByRole(`link`,{name:/Match form/})).toBeInTheDocument(),await s(e.getByText(`+1`)).toBeInTheDocument(),await s(t.querySelectorAll(`a a`)).toHaveLength(0)}},v={args:{event:r({startTime:l(13),location:`Sporthal De Boog`})},play:async({canvas:e,canvasElement:t})=>{let n=e.getByRole(`link`,{name:`Sporthal De Boog`});await s(n).toHaveAttribute(`href`,s.stringContaining(`maps.google.com`)),await s(n).toHaveAttribute(`target`,`_blank`),await s(t.querySelectorAll(`a a`)).toHaveLength(0)}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    event: makeEvent({
