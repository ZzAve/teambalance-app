import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,n,r,t as i}from"./router-decorator-BTXYnuI9.js";import{t as a}from"./jsx-runtime-DeHZSEgm.js";import{n as o,t as s}from"./triangle-alert-Fdo5yeUP.js";import{n as c,t as l}from"./button-DwegqjOI.js";function u({title:e,description:t,onRetry:n,retryLabel:r=`Retry`,children:i}){return(0,d.jsxs)(`div`,{role:`alert`,className:`mt-10 flex flex-col items-center gap-4 text-center`,children:[(0,d.jsx)(`div`,{className:`flex h-12 w-12 items-center justify-center rounded-full bg-red/10 text-red`,children:(0,d.jsx)(s,{size:22})}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`p`,{className:`font-display text-lg font-semibold`,children:e}),t&&(0,d.jsx)(`p`,{className:`mt-1 text-sm text-muted-foreground`,children:t})]}),(0,d.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,d.jsx)(l,{onClick:n,children:r}),i]})]})}var d;function f(){return(f=e((()=>{o(),c(),d=a(),u.__docgenInfo={description:`The shell shown when a query fails to load — distinct from an empty state, so a real failure
