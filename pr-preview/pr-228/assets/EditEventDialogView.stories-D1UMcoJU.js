import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-DZxis02t.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{a as r,i,r as a,t as o}from"./event-fixtures-lW1LLQhc.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./select-Dkm2-L0A.js";import{n as p,t as m}from"./SeriesScopeField-B4HpqmOo.js";import{n as h,t as g}from"./ReferenceRowsEditor-5W3xqvn5.js";import{n as _,t as v}from"./button-DSrE32Ln.js";import{n as y,t as b}from"./input-DzRQFW8J.js";import{n as x,t as S}from"./label-DR_Ax2Js.js";import{n as C,t as w}from"./RosterOverrideField-xwm9BXDX.js";import{r as T,t as E}from"./references-IoGSSQVz.js";function D(e){let t=new Date(e),n=e=>String(e).padStart(2,`0`);return`${t.getFullYear()}-${n(t.getMonth()+1)}-${n(t.getDate())}T${n(t.getHours())}:${n(t.getMinutes())}`}function O(e,t){return`${e.slice(0,10)}T${t}`}function k({event:e,siblings:t=[],eventTypes:n=[],positions:r=[],isPending:i,isError:a,onSubmit:o}){let u=t.length>1,[p,h]=(0,A.useState)(`THIS`),_=u&&p!==`THIS`,[y,x]=(0,A.useState)(e.eventType.id),[C,k]=(0,A.useState)(e.title),[M,N]=(0,A.useState)(D(e.startTime)),[P,F]=(0,A.useState)(D(e.endTime)),[I,L]=(0,A.useState)(T(e.references)),[R,z]=(0,A.useState)(e.rosterOverride),B=n.filter(t=>!t.archived||t.id===e.eventType.id),V=n.find(e=>e.id===y);return(0,j.jsxs)(`form`,{onSubmit:t=>{t.preventDefault();let n=new FormData(t.currentTarget);o({id:e.id,scope:p,eventTypeId:y,title:C,description:n.get(`description`)||void 0,startTime:new Date(M).toISOString(),endTime:new Date(P).toISOString(),location:n.get(`location`)||void 0,references:E(I),rosterOverride:R})},className:`flex flex-col gap-4`,children:[u&&(0,j.jsx)(m,{siblings:t,currentId:e.id,scope:p,onScopeChange:h,variant:`edit`}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(S,{htmlFor:`edit-type`,children:`Type`}),(0,j.jsxs)(f,{value:y,onValueChange:x,children:[(0,j.jsx)(c,{id:`edit-type`,children:(0,j.jsx)(s,{placeholder:`Select type`})}),(0,j.jsx)(l,{children:B.map(e=>(0,j.jsx)(d,{value:e.id,children:(0,j.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,j.jsx)(`span`,{className:`inline-block h-3 w-3 rounded-full`,style:{backgroundColor:e.color??`#888`}}),e.name]})},e.id))})]})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(S,{htmlFor:`edit-title`,children:`Title`}),(0,j.jsx)(b,{id:`edit-title`,required:!0,value:C,onChange:e=>k(e.target.value)})]}),_?(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(S,{htmlFor:`edit-start-time`,children:`Start time`}),(0,j.jsx)(b,{id:`edit-start-time`,type:`time`,required:!0,value:M.slice(11,16),onChange:e=>N(t=>O(t,e.target.value))})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(S,{htmlFor:`edit-end-time`,children:`End time`}),(0,j.jsx)(b,{id:`edit-end-time`,type:`time`,required:!0,value:P.slice(11,16),onChange:e=>F(t=>O(t,e.target.value))})]})]}):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(S,{htmlFor:`edit-start`,children:`Start time`}),(0,j.jsx)(b,{id:`edit-start`,type:`datetime-local`,required:!0,value:M,onChange:e=>N(e.target.value)})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(S,{htmlFor:`edit-end`,children:`End time`}),(0,j.jsx)(b,{id:`edit-end`,type:`datetime-local`,required:!0,value:P,onChange:e=>F(e.target.value)})]})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(S,{htmlFor:`edit-location`,children:`Location (optional)`}),(0,j.jsx)(b,{id:`edit-location`,name:`location`,defaultValue:e.location??``})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(S,{htmlFor:`edit-description`,children:`Description (optional)`}),(0,j.jsx)(b,{id:`edit-description`,name:`description`,defaultValue:e.description??``})]}),(0,j.jsx)(g,{rows:I,onChange:L}),(0,j.jsx)(w,{value:R,eventType:V,positions:r,disabled:i,onChange:z}),a&&(0,j.jsx)(`p`,{className:`rounded-lg border border-red-300 bg-red-500/10 px-3 py-2 text-sm text-red-500`,children:`Could not save changes. Please try again.`}),(0,j.jsx)(v,{type:`submit`,disabled:i,children:i?`Saving…`:`Save changes`})]})}var A,j;function M(){return(M=e((()=>{A=t(),_(),y(),x(),u(),C(),h(),p(),j=n(),k.__docgenInfo={description:`Presentational edit-event form. Owns all local form state (scope, type, title, times, links) and
