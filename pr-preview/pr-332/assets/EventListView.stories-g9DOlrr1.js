import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,r as n}from"./event-fixtures-BltZTX-3.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{n as i,t as a}from"./router-decorator-Bna-6SzR.js";import{n as o,t as s}from"./EventCard-B2pxJhQ5.js";import{n as c,t as l}from"./skeleton-CDDGuF3T.js";function u({events:e,isLoading:t=!1,error:n,emptyMessage:r=`No upcoming events.`,now:i,onRespond:a,optimistic:o,defaultRosterOpen:c,rosterPanel:l}){return e.length===0?t?(0,f.jsx)(d,{}):n?(0,f.jsx)(`p`,{className:`mt-4 text-sm text-red`,children:`Couldn't load events.`}):(0,f.jsx)(`p`,{className:`mt-4 text-muted-foreground`,children:r}):(0,f.jsx)(`div`,{className:`mt-4 flex flex-col gap-3`,children:e.map((e,t)=>{let n=o?.eventId===e.id&&o.state!==e.myState;return(0,f.jsx)(s,{event:e,index:t,now:i,myState:n?o.state:e.myState,pending:n,onRespond:t=>a?.(e.id,t),defaultRosterOpen:c,rosterPanel:l?.(e)},e.id)})})}function d(){return(0,f.jsx)(`div`,{className:`mt-4 flex flex-col gap-3`,role:`status`,"aria-label":`Loading events`,children:[0,1,2].map(e=>(0,f.jsxs)(`div`,{className:`rounded-2xl border border-border/40 bg-card p-3.5 shadow-sm`,children:[(0,f.jsxs)(`div`,{className:`flex gap-3.5`,children:[(0,f.jsx)(l,{className:`h-[62px] w-[54px] shrink-0 rounded-[15px]`}),(0,f.jsxs)(`div`,{className:`min-w-0 flex-1 space-y-2`,children:[(0,f.jsx)(l,{className:`h-4 w-16 rounded-full`}),(0,f.jsx)(l,{className:`h-5 w-2/3`}),(0,f.jsx)(l,{className:`h-3.5 w-1/2`})]})]}),(0,f.jsx)(`div`,{className:`mt-3 border-t border-border/40 pt-3`,children:(0,f.jsx)(l,{className:`h-6 w-40 rounded-full`})})]},e))})}var f;function p(){return(p=e((()=>{c(),o(),f=r(),u.__docgenInfo={description:`Presentational list region of the events page. Renders one of four states from props the
