...
for a team that sets no targets it would be four chips that provably filter nothing.`},showPast:{required:!0,tsType:{name:`boolean`},description:``},resultCount:{required:!0,tsType:{name:`number`},description:`How many events survive the current filter — announced, never shown (ADR-0029).`},onToggleType:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(typeId: string) => void`,signature:{arguments:[{type:{name:`string`},name:`typeId`}],return:{name:`void`}}},description:``},onToggleState:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(state: AttendanceState) => void`,signature:{arguments:[{type:{name:`AttendanceState`},name:`state`}],return:{name:`void`}}},description:``},onToggleTurnout:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(bucket: TurnoutBucket) => void`,signature:{arguments:[{type:{name:`union`,raw:`'missing-position' | 'spots-open' | 'covered' | 'no-target'`,elements:[{name:`literal`,value:`'missing-position'`},{name:`literal`,value:`'spots-open'`},{name:`literal`,value:`'covered'`},{name:`literal`,value:`'no-target'`}]},name:`bucket`}],return:{name:`void`}}},description:``},onToggleShowPast:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(showPast: boolean) => void`,signature:{arguments:[{type:{name:`boolean`},name:`showPast`}],return:{name:`void`}}},description:``},onClearFilters:{required:!0,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:`Resets every dimension. Offered next to the trigger whenever a filter is in effect.`}}}})))()}var b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K;function q(){return(q=e((()=>{r(),d(),p(),y(),{expect:b,fn:x}=__STORYBOOK_MODULE_TEST__,S=[n({id:`et-1`,name:`Training`,color:`#249E6C`}),n({id:`et-2`,name:`Match`,color:`#225C9C`}),n({id:`et-3`,name:`Tournament`,color:`#7B5EA7`})],C=new Set(S.map(e=>e.id)),w=new Set(u),T=new Set(f),E={title:`features/filter-event-types/EventFiltersView`,component:m,args:{eventTypes:S,activeTypeIds:C,activeStates:w,activeTurnouts:T,showTurnout:!0,showPast:!1,resultCount:7,onToggleType:x(),onToggleState:x(),onToggleTurnout:x(),onToggleShowPast:x(),onClearFilters:x()}},D={play:async({canvas:e})=>{await b(e.getByRole(`button`,{name:`Filters`})).toHaveAttribute(`aria-expanded`,`false`),await b(e.queryByRole(`dialog`)).not.toBeInTheDocument(),await b(e.queryByRole(`button`,{name:`Clear filters`})).not.toBeInTheDocument()}},O={args:{activeTypeIds:new Set([`et-2`]),resultCount:2},play:async({canvas:e})=>{await b(e.getByRole(`button`,{name:`Clear filters`})).toBeInTheDocument(),await b(e.getByTestId(`active-filter-dot`)).toBeInTheDocument()}},k={args:{activeTypeIds:new Set([`et-2`]),resultCount:2},parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getByRole(`button`,{name:`Clear filters`})),await b(n.onClearFilters).toHaveBeenCalled()}},A={args:{showPast:!0},parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getByRole(`button`,{name:`Clear filters`})),await b(n.onClearFilters).toHaveBeenCalled()}},j={play:async({canvas:e,userEvent:t})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await b(e.getByRole(`dialog`,{name:`Filters`})).toBeInTheDocument(),await b(e.getByRole(`button`,{name:`Training`})).toBeInTheDocument(),await b(e.getByRole(`group`,{name:`Your answer`})).toBeInTheDocument(),await b(e.getByRole(`group`,{name:`Turnout`})).toBeInTheDocument(),await b(e.getByRole(`switch`,{name:`Show past events`})).toHaveAttribute(`aria-checked`,`false`),await b(e.getByText(`Off — upcoming only`)).toBeInTheDocument();for(let t of[`Going`,`Maybe`,`Can't`,`Not responded`,`Missing a position`,`Spots open`,`Covered`,`No target set`])await b(e.getByRole(`button`,{name:t})).toHaveAttribute(`aria-pressed`,`true`);await b(e.queryByTestId(`active-filter-dot`)).not.toBeInTheDocument()}},M={parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await t.click(e.getByRole(`button`,{name:`Match`})),await b(n.onToggleType).toHaveBeenCalledWith(`et-2`)}},N={parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await t.click(e.getByRole(`switch`,{name:`Show past events`})),await b(n.onToggleShowPast).toHaveBeenCalledWith(!0)}},P={args:{showPast:!0},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await b(e.getByRole(`switch`,{name:`Show past events`})).toHaveAttribute(`aria-checked`,`true`),await b(e.getByText(`On — past events included`)).toBeInTheDocument(),await t.click(e.getByRole(`switch`,{name:`Show past events`})),await b(n.onToggleShowPast).toHaveBeenCalledWith(!1)}},F={parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e,userEvent:t})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await b(e.getByRole(`dialog`,{name:`Filters`})).toBeInTheDocument(),await t.keyboard(`{Escape}`),await b(e.queryByRole(`dialog`)).not.toBeInTheDocument()}},I={args:{eventTypes:[],activeTypeIds:new Set},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await b(e.queryByText(`Event types`)).not.toBeInTheDocument(),await t.click(e.getByRole(`switch`,{name:`Show past events`})),await b(n.onToggleShowPast).toHaveBeenCalledWith(!0)}},L={args:{activeTypeIds:new Set([`et-2`])},play:async({canvas:e,userEvent:t})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await b(e.getByRole(`button`,{name:`Match`})).toHaveAttribute(`aria-pressed`,`true`),await b(e.getByRole(`button`,{name:`Training`})).toHaveAttribute(`aria-pressed`,`false`)}},R={parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await t.click(e.getByRole(`button`,{name:`Not responded`})),await b(n.onToggleState).toHaveBeenCalledWith(`NOT_RESPONDED`)}},z={args:{activeStates:new Set([`NOT_RESPONDED`]),resultCount:3},play:async({canvas:e,userEvent:t})=>{await b(e.getByTestId(`active-filter-dot`)).toBeInTheDocument(),await t.click(e.getByRole(`button`,{name:`Filters`})),await b(e.getByRole(`button`,{name:`Not responded`})).toHaveAttribute(`aria-pressed`,`true`),await b(e.getByRole(`button`,{name:`Going`})).toHaveAttribute(`aria-pressed`,`false`),await b(e.getByRole(`button`,{name:`Training`})).toHaveAttribute(`aria-pressed`,`true`)}},B={args:{activeStates:new Set([`NOT_RESPONDED`]),resultCount:3},parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await t.click(e.getByRole(`button`,{name:`Maybe`})),await b(n.onToggleState).toHaveBeenCalledWith(`MAYBE`)}},V={args:{resultCount:1},parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e})=>{await b(e.getByText(`1 event matches these filters`)).toBeInTheDocument()}},H={parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await t.click(e.getByRole(`button`,{name:`Spots open`})),await b(n.onToggleTurnout).toHaveBeenCalledWith(`spots-open`)}},U={args:{activeTurnouts:new Set([`missing-position`]),resultCount:2},play:async({canvas:e,userEvent:t})=>{await b(e.getByTestId(`active-filter-dot`)).toBeInTheDocument(),await t.click(e.getByRole(`button`,{name:`Filters`})),await b(e.getByRole(`button`,{name:`Missing a position`})).toHaveAttribute(`aria-pressed`,`true`);for(let t of[`Spots open`,`Covered`,`No target set`])await b(e.getByRole(`button`,{name:t})).toHaveAttribute(`aria-pressed`,`false`);await b(e.getByRole(`button`,{name:`Going`})).toHaveAttribute(`aria-pressed`,`true`)}},W={args:{activeTurnouts:new Set([`missing-position`]),resultCount:2},parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await t.click(e.getByRole(`button`,{name:`Spots open`})),await b(n.onToggleTurnout).toHaveBeenCalledWith(`spots-open`)}},G={args:{showTurnout:!1},play:async({canvas:e,userEvent:t})=>{await t.click(e.getByRole(`button`,{name:`Filters`})),await b(e.queryByRole(`group`,{name:`Turnout`})).not.toBeInTheDocument(),await b(e.queryByRole(`button`,{name:`Spots open`})).not.toBeInTheDocument(),await b(e.getByRole(`group`,{name:`Your answer`})).toBeInTheDocument(),await b(e.getByRole(`switch`,{name:`Show past events`})).toBeInTheDocument()}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvas
  }) => {
...
}`,...G.parameters?.docs?.source}}},K=[`Closed`,`ClearFiltersVisible`,`ClearsFilters`,`ClearFiltersVisibleForShowPastAlone`,`Open`,`TogglesType`,`TogglesShowPast`,`ShowingPast`,`ClosesOnEscape`,`WithoutEventTypes`,`FilteredToOneType`,`TogglesState`,`FilteredToNotResponded`,`TogglesSecondStateBackOn`,`AnnouncesResultCount`,`TogglesTurnout`,`FilteredToMissingAPosition`,`TogglesSecondTurnoutBackOn`,`WithoutTurnout`]})))()}q();export{V as AnnouncesResultCount,O as ClearFiltersVisible,A as ClearFiltersVisibleForShowPastAlone,k as ClearsFilters,D as Closed,F as ClosesOnEscape,U as FilteredToMissingAPosition,z as FilteredToNotResponded,L as FilteredToOneType,j as Open,P as ShowingPast,B as TogglesSecondStateBackOn,W as TogglesSecondTurnoutBackOn,N as TogglesShowPast,R as TogglesState,H as TogglesTurnout,M as TogglesType,I as WithoutEventTypes,G as WithoutTurnout,K as __namedExportsOrder,E as default};