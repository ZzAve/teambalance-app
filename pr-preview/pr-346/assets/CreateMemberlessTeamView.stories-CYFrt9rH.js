import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-xLdGEXpd.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./button-CmeF9f-4.js";import{n as a,t as o}from"./input-D5a5PVWS.js";import{n as s,t as c}from"./label-CRMRXejn.js";import{n as l,t as u}from"./teams-DLysQvyn.js";function d({isPending:e,error:t,createdName:n,onSubmit:r}){let[a,s]=(0,f.useState)(``),[l,u]=(0,f.useState)(``),d=l.length>0&&!m.test(l)?`Use lowercase letters, numbers, and hyphens.`:null,h=a.trim().length>0&&l.length>0&&d===null&&!e,g=e=>{e.preventDefault(),h&&r({name:a.trim(),slug:l})},_=(...e)=>t&&e.includes(t.code)?t.message:null,v=_(`INVALID_NAME`),y=_(`INVALID_SLUG`,`SLUG_TAKEN`)??d,b=_(`GENERIC`,`INVALID_CREATION_CODE`);return(0,p.jsxs)(`form`,{onSubmit:g,className:`flex flex-col gap-3`,children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`h2`,{className:`font-display text-title font-bold`,children:`Create a team`}),(0,p.jsx)(`p`,{className:`mt-1 text-small text-muted-foreground`,children:`Creates an empty team you can enter and set up, then hand over with an admin invite link. You don't join it.`})]}),b&&(0,p.jsx)(`p`,{role:`alert`,className:`text-small text-destructive`,children:b}),n&&!b&&(0,p.jsxs)(`p`,{role:`status`,className:`text-small text-green`,children:[`Created “`,n,`”. Enter it from the list below to set it up.`]}),(0,p.jsxs)(`div`,{children:[(0,p.jsx)(c,{htmlFor:`ml-team-name`,children:`Team name`}),(0,p.jsx)(o,{id:`ml-team-name`,value:a,disabled:e,onChange:e=>s(e.target.value),placeholder:`e.g. Tovo Dames 5`}),v&&(0,p.jsx)(`p`,{className:`mt-1 text-small text-destructive`,children:v})]}),(0,p.jsxs)(`div`,{children:[(0,p.jsx)(c,{htmlFor:`ml-team-slug`,children:`Team address`}),(0,p.jsx)(o,{id:`ml-team-slug`,value:l,disabled:e,onChange:e=>u(e.target.value),placeholder:`tovo-dames-5`}),y&&(0,p.jsx)(`p`,{className:`mt-1 text-small text-destructive`,children:y})]}),(0,p.jsx)(i,{type:`submit`,disabled:!h,className:`self-start`,children:e?`Creating…`:`Create team`})]})}var f,p,m;function h(){return(h=e((()=>{f=t(),r(),a(),s(),p=n(),m=/^[a-z0-9]+(-[a-z0-9]+)*$/,d.__docgenInfo={description:`Presentational memberless-create form for the platform console (ADR-0024 §5). Prop-only
