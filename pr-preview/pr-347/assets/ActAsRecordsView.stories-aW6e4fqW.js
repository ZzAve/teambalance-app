import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t}from"./iframe-exsfVg0I.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./stack-CKd6OPi-.js";import{n as a,t as o}from"./chevron-right-_SnQnxqX.js";function s({records:e=[],isLoading:t,isError:n}){let[r,i]=(0,u.useState)(!1),[a,s]=(0,u.useState)(null),[m,g]=(0,u.useState)(!1),_=e=>{s(t=>t===e?null:e),g(!1)};return(0,d.jsxs)(`section`,{children:[(0,d.jsx)(`h3`,{className:`font-display text-lg font-bold`,children:`Platform access`}),(0,d.jsx)(`p`,{className:`mt-1 text-sm text-muted-foreground`,children:`When the people who run TeamBalance worked inside your team.`}),t&&(0,d.jsx)(`p`,{className:`mt-3 text-sm text-muted-foreground`,children:`Loading…`}),n&&(0,d.jsx)(`p`,{className:`mt-3 text-sm text-red`,children:`Couldn't load platform access. Please try again.`}),!t&&!n&&(e.length===0?(0,d.jsx)(`p`,{className:`mt-3 text-sm text-muted-foreground`,children:`The TeamBalance owner has never worked in your team.`}):(0,d.jsxs)(`div`,{className:`mt-3`,children:[(0,d.jsxs)(`button`,{type:`button`,"aria-expanded":r,onClick:()=>i(e=>!e),className:`flex w-full items-center gap-2 rounded-lg border border-border bg-card p-3 text-left transition-colors hover:bg-card-hover`,children:[(0,d.jsx)(o,{size:16,className:`shrink-0 text-muted-foreground transition-transform duration-200 ${r?`rotate-90`:``}`}),(0,d.jsx)(`span`,{className:`text-sm font-medium`,children:f(e.length)})]}),r&&(0,d.jsx)(`ul`,{className:`mt-2 divide-y divide-border rounded-lg border border-border`,children:e.map(e=>{let t=`${e.enteredAt}-${e.actorKind}`,n=a===t;return(0,d.jsxs)(`li`,{children:[(0,d.jsxs)(`button`,{type:`button`,"aria-expanded":n,onClick:()=>_(t),className:`flex w-full items-center gap-2 p-3 text-left`,children:[(0,d.jsx)(o,{size:15,className:`shrink-0 text-muted-foreground transition-transform duration-200 ${n?`rotate-90`:``}`}),(0,d.jsxs)(`span`,{children:[(0,d.jsxs)(`span`,{className:`block text-sm font-medium`,children:[c(e.actorKind),` worked in your team`]}),(0,d.jsx)(`span`,{className:`block text-sm text-muted-foreground`,children:l(e)})]})]}),n&&(0,d.jsxs)(`div`,{className:`pb-3 pl-9 pr-3 text-sm`,children:[(0,d.jsxs)(`dl`,{className:`grid grid-cols-[auto_1fr] gap-x-4 gap-y-1`,children:[(0,d.jsx)(`dt`,{className:`text-muted-foreground`,children:`Started`}),(0,d.jsx)(`dd`,{children:h(new Date(e.enteredAt))}),(0,d.jsx)(`dt`,{className:`text-muted-foreground`,children:`Ended`}),(0,d.jsx)(`dd`,{children:p(e)}),(0,d.jsx)(`dt`,{className:`text-muted-foreground`,children:`Acting as`}),(0,d.jsx)(`dd`,{children:`An admin of your team`})]}),(0,d.jsx)(`button`,{type:`button`,"aria-expanded":m,onClick:()=>g(e=>!e),className:`mt-3 text-sm font-medium text-blue underline underline-offset-4`,children:`Why does this happen?`}),m&&(0,d.jsxs)(`div`,{className:`mt-2 flex flex-col gap-2 border-l-2 border-border pl-3 text-sm text-muted-foreground`,children:[(0,d.jsx)(`p`,{children:`TeamBalance is run by a small team. The owner works inside a team to set it up, prepare a season, or fix something that was reported.`}),(0,d.jsx)(`p`,{children:`Access lasts an hour at a time and is never silent — it is listed here whether or not anything changed.`})]})]})]},t)})})]}))]})}function c(e){return e===`MEMBER`?`A team member`:`The TeamBalance owner`}function l(e){let t=new Date(e.enteredAt),n=m(e);return`${h(t)} – ${t.toDateString()===n.toDateString()?g(n):h(n)}`}var u,d,f,p,m,h,g;function _(){return(_=e((()=>{u=t(),a(),d=n(),f=e=>e===1?`The TeamBalance owner worked here once`:`The TeamBalance owner worked here ${e} times`,p=e=>e.exitedAt?`${g(m(e))}, when they left`:`${g(m(e))}, when the hour ran out`,m=e=>new Date(e.exitedAt??e.lastActiveAt),h=e=>e.toLocaleString(void 0,{day:`numeric`,month:`short`,hour:`2-digit`,minute:`2-digit`}),g=e=>e.toLocaleTimeString(void 0,{hour:`2-digit`,minute:`2-digit`}),s.__docgenInfo={description:`The Admin-visible **Act-as Record** (ADR-0024 §4): what platform access this Team has had.
