import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t}from"./iframe-Dnrk4Q1i.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./stack-CKd6OPi-.js";import{n as a,t as o}from"./button-W1GRNbO0.js";import{n as s,t as c}from"./input-DRR9bnA7.js";import{n as l,t as u}from"./label-DNAgJ93K.js";import{n as d,t as f}from"./teams-DLysQvyn.js";function p({isPending:e,error:t,createdName:n,onSubmit:r}){let[i,a]=(0,m.useState)(``),[s,l]=(0,m.useState)(``),d=s.length>0&&!g.test(s)?`Use lowercase letters, numbers, and hyphens.`:null,f=i.trim().length>0&&s.length>0&&d===null&&!e,p=e=>{e.preventDefault(),f&&r({name:i.trim(),slug:s})},_=(...e)=>t&&e.includes(t.code)?t.message:null,v=_(`INVALID_NAME`),y=_(`INVALID_SLUG`,`SLUG_TAKEN`)??d,b=_(`GENERIC`,`INVALID_CREATION_CODE`);return(0,h.jsxs)(`form`,{onSubmit:p,className:`flex flex-col gap-3`,children:[(0,h.jsxs)(`div`,{children:[(0,h.jsx)(`h2`,{className:`font-display text-2xl font-bold`,children:`Create a team`}),(0,h.jsx)(`p`,{className:`mt-1 text-sm text-muted-foreground`,children:`Creates an empty team you can enter and set up, then hand over with an admin invite link. You don't join it.`})]}),b&&(0,h.jsx)(`p`,{role:`alert`,className:`text-sm text-destructive`,children:b}),n&&!b&&(0,h.jsxs)(`p`,{role:`status`,className:`text-sm text-green`,children:[`Created “`,n,`”. Enter it from the list below to set it up.`]}),(0,h.jsxs)(`div`,{children:[(0,h.jsx)(u,{htmlFor:`ml-team-name`,children:`Team name`}),(0,h.jsx)(c,{id:`ml-team-name`,value:i,disabled:e,onChange:e=>a(e.target.value),placeholder:`e.g. Tovo Dames 5`}),v&&(0,h.jsx)(`p`,{className:`mt-1 text-sm text-destructive`,children:v})]}),(0,h.jsxs)(`div`,{children:[(0,h.jsx)(u,{htmlFor:`ml-team-slug`,children:`Team address`}),(0,h.jsx)(c,{id:`ml-team-slug`,value:s,disabled:e,onChange:e=>l(e.target.value),placeholder:`tovo-dames-5`}),y&&(0,h.jsx)(`p`,{className:`mt-1 text-sm text-destructive`,children:y})]}),(0,h.jsx)(o,{type:`submit`,disabled:!f,className:`self-start`,children:e?`Creating…`:`Create team`})]})}var m,h,g;function _(){return(_=e((()=>{m=t(),a(),s(),l(),h=n(),g=/^[a-z0-9]+(-[a-z0-9]+)*$/,p.__docgenInfo={description:`Presentational memberless-create form for the platform console (ADR-0024 §5). Prop-only
