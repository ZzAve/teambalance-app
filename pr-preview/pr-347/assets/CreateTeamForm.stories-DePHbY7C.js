import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t}from"./iframe-Dnrk4Q1i.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./stack-CKd6OPi-.js";import{n as a,t as o}from"./button-W1GRNbO0.js";import{n as s,t as c}from"./input-DRR9bnA7.js";import{n as l,t as u}from"./label-DNAgJ93K.js";import{n as d,t as f}from"./teams-DLysQvyn.js";function p(e){return e.length===0?`Choose a team address.`:e.length>58?`Use 58 characters or fewer.`:m.test(e)?null:`Use lowercase letters, numbers, and hyphens.`}var m;function h(){return(h=e((()=>{m=/^[a-z0-9]+(-[a-z0-9]+)*$/})))()}function g(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``).slice(0,58).replace(/-+$/g,``)}function _(){return(_=e((()=>{h()})))()}function v({isPending:e,error:t,onSubmit:n,reassuranceDelayMs:r=5e3}){let[i,a]=(0,y.useState)(``),[s,l]=(0,y.useState)(``),[d,f]=(0,y.useState)(!1),[m,h]=(0,y.useState)(``),[_,v]=(0,y.useState)(!1),x=e=>{a(e),d||l(g(e))};(0,y.useEffect)(()=>{if(!e)return;let t=setTimeout(()=>v(!0),r);return()=>{clearTimeout(t),v(!1)}},[e,r]);let S=s.length>0?p(s):null,C=i.trim().length>0&&m.trim().length>0&&S===null&&s.length>0&&!e,w=e=>{e.preventDefault(),C&&n({name:i.trim(),slug:s,creationCode:m.trim()})},T=(...e)=>t&&e.includes(t.code)?t.message:null,E=T(`INVALID_NAME`),D=T(`INVALID_SLUG`,`SLUG_TAKEN`)??S,O=T(`INVALID_CREATION_CODE`),k=T(`GENERIC`);return(0,b.jsxs)(`form`,{onSubmit:w,className:`flex flex-col gap-4`,children:[k&&(0,b.jsx)(`p`,{role:`alert`,className:`text-sm text-destructive`,children:k}),(0,b.jsxs)(`div`,{children:[(0,b.jsx)(u,{htmlFor:`team-name`,children:`Team name`}),(0,b.jsx)(c,{id:`team-name`,value:i,disabled:e,onChange:e=>x(e.target.value),placeholder:`e.g. Tovo Heren 4`}),E&&(0,b.jsx)(`p`,{className:`mt-1 text-sm text-destructive`,children:E})]}),(0,b.jsxs)(`div`,{children:[(0,b.jsx)(u,{htmlFor:`team-slug`,children:`Team address`}),(0,b.jsx)(c,{id:`team-slug`,value:s,disabled:e,onChange:e=>{l(e.target.value),f(!0)},placeholder:`tovo-heren-4`}),D&&(0,b.jsx)(`p`,{className:`mt-1 text-sm text-destructive`,children:D})]}),(0,b.jsxs)(`div`,{children:[(0,b.jsx)(u,{htmlFor:`creation-code`,children:`Creation code`}),(0,b.jsx)(c,{id:`creation-code`,value:m,disabled:e,onChange:e=>h(e.target.value),placeholder:`Enter your creation code`}),O&&(0,b.jsx)(`p`,{className:`mt-1 text-sm text-destructive`,children:O})]}),(0,b.jsx)(o,{type:`submit`,disabled:!C,children:e?`Creating your team…`:`Create team`}),e&&_&&(0,b.jsx)(`p`,{className:`text-sm text-muted-foreground`,children:`Setting up your team's space — this can take a few seconds…`})]})}var y,b;function x(){return(x=e((()=>{y=t(),a(),s(),l(),_(),h(),b=n(),v.__docgenInfo={description:`Presentational create-team form (#158). Prop-only (isPending / error / onSubmit) so every state is a
