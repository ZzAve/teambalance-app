import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t}from"./iframe-exsfVg0I.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./stack-CKd6OPi-.js";import{a,r as o}from"./event-fixtures-CuRrQuRB.js";import{n as s,t as c}from"./SeriesScopeField-UgIVZ4ME.js";import{n as l,t as u}from"./button-BcU7NJ34.js";import{i as d,s as f}from"./dialog-BfGu6ZFh.js";function p({eventId:e,siblings:t=[],isPending:n,isError:r,onDelete:i,onCancel:a}){let o=t.length>1,[s,l]=(0,m.useState)(`THIS`);return(0,h.jsxs)(h.Fragment,{children:[o&&(0,h.jsx)(c,{siblings:t,currentId:e,scope:s,onScopeChange:l,variant:`delete`}),r&&(0,h.jsx)(`p`,{className:`rounded-lg border border-red/40 bg-red/10 px-3 py-2 text-sm text-red`,children:`Could not delete the event. Please try again.`}),(0,h.jsxs)(d,{children:[(0,h.jsx)(u,{variant:`outline`,onClick:a,disabled:n,children:`Cancel`}),(0,h.jsx)(u,{variant:`destructive`,onClick:()=>i(s),disabled:n,children:n?`Deleting…`:o&&s!==`THIS`?`Delete events`:`Delete event`})]})]})}var m,h;function g(){return(g=e((()=>{m=t(),f(),l(),s(),h=n(),p.__docgenInfo={description:`Presentational body of the delete-event dialog. Owns the local scope state and hands the chosen
