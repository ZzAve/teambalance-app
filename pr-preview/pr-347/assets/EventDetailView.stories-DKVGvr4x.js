import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,r as n}from"./iframe-exsfVg0I.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{n as i,t as a}from"./stack-CKd6OPi-.js";import{a as o,i as s,r as c,s as l,t as u}from"./event-fixtures-CuRrQuRB.js";import{n as d,t as f}from"./createLucideIcon-B2a5Rw58.js";import{n as p,t as m}from"./EventTypeIcon-B2DSqDhS.js";import{n as h,t as ee}from"./ReferenceChips-BmLDGQIp.js";import{n as g,t as te}from"./map-pin-BRiNIUsf.js";import{n as ne,t as re}from"./pencil-DDpIRvQk.js";import{i as ie,r as ae}from"./router-decorator-cUhowlgG.js";import{n as oe,t as se}from"./EventTypeBadge-BKy9uOZw.js";import{n as ce,t as le}from"./EventDetailSkeleton-DJyOgJIk.js";import{n as _,t as v}from"./button-BcU7NJ34.js";import{n as y,t as b}from"./RoleBreakdown-DzPq8mLr.js";import{n as ue,t as x}from"./RosterBar-04ubIBbL.js";import{i as S,n as C,r as w,t as de}from"./SeriesPeek-BgNQXI1V.js";import{n as fe,r as pe,t as T}from"./app-shell-decorator-CImNfVh8.js";import{n as me,t as he}from"./AttendanceToggle-DNh2Zsne.js";import{n as ge,t as _e}from"./QueryErrorState-vPXYZWgv.js";import{n as E,t as D}from"./AttendeeList-DqR6UtMX.js";import{n as O,t as k}from"./PageHeader-aGYmSMJX.js";var A,j;function M(){return(M=e((()=>{d(),A=[[`path`,{d:`M10 11v6`,key:`nco0om`}],[`path`,{d:`M14 11v6`,key:`outv1u`}],[`path`,{d:`M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6`,key:`miytrc`}],[`path`,{d:`M3 6h18`,key:`d0wm0j`}],[`path`,{d:`M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2`,key:`e791ji`}]],j=f(`trash-2`,A)})))()}function N({isLoading:e,isError:t,onRetry:n,backTo:r,event:i,currentUserId:a,myState:o,myAttribution:s,isPending:c=!1,onToggleMine:l,onRespond:u,seriesPeek:d,adminActions:f}){if(e)return(0,P.jsx)(le,{});if(t)return(0,P.jsx)(_e,{title:`Couldn't load this event`,description:`Something went wrong on our end. Give it another try.`,onRetry:()=>n?.(),children:(0,P.jsx)(v,{asChild:!0,variant:`ghost`,children:(0,P.jsx)(ae,{to:r,children:`Back to events`})})});if(!i)return(0,P.jsx)(`p`,{children:`Event not found.`});let p=new Date(i.startTime),h=i.roster.positions.some(e=>e.required!=null),g=h||i.roster.trackRoster;return(0,P.jsxs)(`div`,{children:[(0,P.jsx)(k,{title:i.title,backTo:r,backLabel:`Back to events`}),(0,P.jsxs)(`div`,{className:`mt-2 flex items-start gap-4`,children:[(0,P.jsx)(m,{type:i.eventType,size:`md`}),(0,P.jsxs)(`div`,{className:`min-w-0`,children:[(0,P.jsx)(se,{type:i.eventType}),(0,P.jsx)(`h1`,{className:`font-display text-2xl font-bold leading-tight`,children:i.title}),(0,P.jsxs)(`p`,{className:`mt-1 text-sm text-muted-foreground`,children:[p.toLocaleDateString(`nl-NL`,{weekday:`long`,day:`numeric`,month:`long`,year:`numeric`}),` · `,p.toLocaleTimeString(`nl-NL`,{hour:`2-digit`,minute:`2-digit`})]}),i.location&&(0,P.jsxs)(`a`,{href:`https://maps.google.com/?q=${encodeURIComponent(i.location)}`,target:`_blank`,rel:`noopener noreferrer`,className:`mt-0.5 flex items-center gap-1 text-sm text-muted-foreground hover:text-blue hover:underline`,children:[(0,P.jsx)(te,{size:13,className:`shrink-0`}),i.location]})]})]}),g&&(0,P.jsx)(`div`,{className:`mt-6 overflow-hidden rounded-2xl border border-border/40 bg-card shadow-sm`,children:(0,P.jsx)(x,{roster:i.roster})}),a&&(0,P.jsxs)(`div`,{className:`mt-6`,children:[(0,P.jsx)(`p`,{className:`mb-3 text-xs font-semibold uppercase tracking-widest text-muted-foreground`,children:`Your response`}),(0,P.jsx)(`div`,{role:`group`,"aria-label":`Your response`,children:(0,P.jsx)(he,{value:o,disabled:c,onToggle:l})}),s&&(0,P.jsxs)(`p`,{className:`mt-2 text-xs text-muted-foreground`,children:[`set by `,s]})]}),i.description&&(0,P.jsxs)(`div`,{className:`mt-6 rounded-2xl border border-border/40 bg-card p-4 shadow-sm`,children:[(0,P.jsx)(`p`,{className:`mb-2 text-xs font-semibold uppercase tracking-widest text-muted-foreground`,children:`Description`}),(0,P.jsx)(`p`,{className:`text-sm leading-relaxed text-muted-foreground`,children:i.description})]}),i.references.length>0&&(0,P.jsxs)(`div`,{className:`mt-6 rounded-2xl border border-border/40 bg-card p-4 shadow-sm`,children:[(0,P.jsx)(`p`,{className:`mb-3 text-xs font-semibold uppercase tracking-widest text-muted-foreground`,children:`Additional info`}),(0,P.jsx)(ee,{references:i.references,max:i.references.length})]}),(0,P.jsxs)(`div`,{className:`mt-6 overflow-hidden rounded-2xl border border-border/40 bg-card shadow-sm`,children:[!h&&(0,P.jsx)(b,{breakdown:i.attendanceSummary.roleBreakdown}),(0,P.jsx)(D,{attendees:i.attendances,roster:i.roster,currentUserId:a,onRespond:u,pending:c})]}),d&&(0,P.jsx)(de,{peek:d}),f&&(0,P.jsx)(`div`,{className:`mt-6 flex gap-2.5 border-t border-border/40 pt-5`,children:f})]})}var P;function F(){return(F=e((()=>{ie(),g(),_(),ge(),oe(),p(),ce(),h(),y(),ue(),C(),E(),O(),me(),P=r(),N.__docgenInfo={description:`The event-detail page laid out (ADR-0031 §3): load and error shells, then the header, roster
