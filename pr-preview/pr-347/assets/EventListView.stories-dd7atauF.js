import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n,t as r}from"./stack-CKd6OPi-.js";import{a as i,i as a,r as o}from"./event-fixtures-CuRrQuRB.js";import{n as s,t as c}from"./router-decorator-Bt7JvMFd.js";import{n as l,t as u}from"./EventListView-BEZx-_Gx.js";var d,f,p,m,h,g,_,v,y,b,x;function S(){return(S=e((()=>{c(),n(),o(),l(),d=t(),{expect:f,fn:p,within:m}=__STORYBOOK_MODULE_TEST__,h=new Date(2026,7,10,9,0),g=e=>new Date(2026,7,e,20,0).toISOString(),_={title:`entities/event/EventListView`,component:u,decorators:[s],args:{now:h,events:[]}},v={parameters:{chromatic:{disableSnapshot:!0}},args:{events:[i({id:`evt-1`,title:`League Match`,startTime:g(11)}),i({id:`evt-2`,title:`Training`,startTime:g(13)}),i({id:`evt-3`,title:`Regio-toernooi`,startTime:g(29)})]},play:async({canvas:e})=>{await f(e.getByText(`League Match`)).toBeInTheDocument(),await f(e.getByText(`Training`)).toBeInTheDocument(),await f(e.getByText(`Regio-toernooi`)).toBeInTheDocument(),await f(e.queryByText(`This Week`)).not.toBeInTheDocument(),await f(e.queryByText(`Later`)).not.toBeInTheDocument()}},y={render:e=>(0,d.jsx)(r,{items:{Loading:(0,d.jsx)(u,{...e,events:[],isLoading:!0}),Error:(0,d.jsx)(u,{...e,events:[],error:Error(`boom`)}),Empty:(0,d.jsx)(u,{...e,events:[]}),"Filtered to nothing":(0,d.jsx)(u,{...e,events:[],emptyMessage:`No events for this type.`}),"Data despite background error":(0,d.jsx)(u,{...e,error:Error(`refetch failed`),events:[i({id:`evt-1`,title:`League Match`,startTime:g(11)})]}),Attribution:(0,d.jsx)(u,{...e,currentUserId:`u-me`,events:[i({id:`evt-1`,title:`League Match`,startTime:g(11),myState:`ABSENT`,attendances:[a(`u-me`,`Me`,`Unassigned`,{state:`ABSENT`,changedBy:`u-tim`}),a(`u-tim`,`Tim de Vries`,`Unassigned`,{changedBy:`u-tim`})]}),i({id:`evt-2`,title:`Training`,startTime:g(13),myState:`ATTENDING`,attendances:[a(`u-me`,`Me`,`Unassigned`,{changedBy:`u-me`})]})]}),"Attribution clears while settling":(0,d.jsx)(u,{...e,currentUserId:`u-me`,optimistic:{eventId:`evt-1`,state:`ATTENDING`},events:[i({id:`evt-1`,title:`League Match`,startTime:g(11),myState:`ABSENT`,attendances:[a(`u-me`,`Me`,`Unassigned`,{state:`ABSENT`,changedBy:`u-tim`}),a(`u-tim`,`Tim de Vries`,`Unassigned`,{changedBy:`u-tim`})]})]})}}),play:async({canvas:e})=>{let t=t=>m(e.getByRole(`region`,{name:t}));await f(t(`Loading`).getByRole(`status`,{name:/loading events/i})).toBeInTheDocument(),await f(t(`Error`).getByText(/couldn't load events/i)).toBeInTheDocument(),await f(t(`Empty`).getByText(`No upcoming events.`)).toBeInTheDocument(),await f(t(`Filtered to nothing`).getByText(`No events for this type.`)).toBeInTheDocument(),await f(t(`Data despite background error`).getByText(`League Match`)).toBeInTheDocument(),await f(t(`Data despite background error`).queryByText(/couldn't load events/i)).not.toBeInTheDocument(),await f(t(`Attribution`).getByText(`Tim de Vries said you're out`)).toBeInTheDocument(),await f(t(`Attribution`).getByText(`You're in`)).toBeInTheDocument(),await f(t(`Attribution clears while settling`).getByText(`You're in`)).toBeInTheDocument(),await f(t(`Attribution clears while settling`).queryByText(/ said /)).not.toBeInTheDocument()}},b={parameters:{chromatic:{disableSnapshot:!0}},args:{onRespond:p(),events:[i({id:`evt-1`,title:`League Match`,startTime:g(11)}),i({id:`evt-2`,title:`Training`,startTime:g(13)})]},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getAllByRole(`button`,{name:/Change your answer/})[1]),await t.click(e.getByRole(`button`,{name:/^Going$/})),await f(n.onRespond).toHaveBeenCalledWith(`evt-2`,`ATTENDING`)}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  parameters: {
    chromatic: {
