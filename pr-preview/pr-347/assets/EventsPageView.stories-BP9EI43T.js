import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,i as n,r}from"./iframe-DrbUYmN2.js";import{t as i}from"./jsx-runtime-DeHZSEgm.js";import{n as a,t as o}from"./stack-D1VBtmRF.js";import{a as s,i as c,o as l,r as u,s as d,t as f}from"./event-fixtures-CuRrQuRB.js";import{n as p,t as m}from"./PanelViewMenu-BE35mV_h.js";import{n as h,t as ee}from"./plus-o4BiMZ_A.js";import{a as g,i as _,n as v,o as y,r as b,s as x,t as te}from"./EventFiltersView-yGcbEu8K.js";import{i as ne,r as re}from"./EventCard-kUqcBWBt.js";import{n as ie,t as ae}from"./EventListView-BX78B66e.js";import{n as oe,t as se}from"./button-CmXzxiAJ.js";import{n as ce,r as le,t as ue}from"./app-shell-decorator-AP57wL0p.js";import{n as de,t as fe}from"./BulkAttendBarView-Du37mdIK.js";import{n as pe,t as me}from"./NextEventHeroView-CEctnZ--.js";import{n as he,t as ge}from"./EventRosterPanel-Bc28tgyM.js";function _e(e,t){let n=e.filter(e=>new Date(e.startTime).getTime()>=t.getTime()).reduce((e,t)=>e===null||new Date(t.startTime)<new Date(e.startTime)?t:e,null);return n===null?null:re(n.startTime,t)<=7?n:null}function S(){return(S=e((()=>{ne()})))()}function ve(e,t,n,r){return e.filter(e=>t.has(e.eventType.id)&&n.has(e.myState)&&r.has(g(e.roster.state)))}function C(){return(C=e((()=>{_()})))()}function ye({hasHero:e,showPast:t,activeTypeIds:n,allTypeIds:r,activeStates:i,activeTurnouts:a}){if(e)return`Nothing else coming up.`;let o=n.size<r.length,s=i.size<y.length,c=a.size<b.length,l=[o,s,c].filter(Boolean).length;if(l===0)return t?`No events yet.`:`No upcoming events.`;if(l===1){if(o)return`No events for this type.`;if(s&&i.size===1&&i.has(`NOT_RESPONDED`))return`Nothing needs your answer.`;if(c&&[...a].every(e=>w.includes(e)))return`No events are short of players.`}return`No events match these filters.`}var w;function T(){return(T=e((()=>{x(),_(),w=[`missing-position`,`spots-open`]})))()}function E(e){let t=new Map;for(let n of e){let e=t.get(n.eventType.id);e?e.events.push(n):t.set(n.eventType.id,{typeId:n.eventType.id,typeName:n.eventType.name,events:[n]})}return[...t.values()].sort((e,t)=>t.events.length-e.events.length||e.typeName.localeCompare(t.typeName))}function be(e,t,n){return e?e.filter(e=>t.has(e.eventType.id)&&e.myState===`NOT_RESPONDED`&&new Date(e.startTime)>=n):[]}function D({createAction:e,filters:t,panelMenu:n,hero:r,bulkBar:i,list:a}){return(0,O.jsxs)(`div`,{children:[(0,O.jsxs)(`div`,{className:`flex items-center justify-between gap-2`,children:[(0,O.jsx)(`h2`,{className:`font-display text-title font-bold`,children:`Events`}),(0,O.jsxs)(`div`,{className:`flex items-center gap-2`,children:[e,(0,O.jsx)(te,{...t}),(0,O.jsx)(m,{...n})]})]}),r,i,(0,O.jsx)(ae,{...a})]})}var O;function k(){return(k=e((()=>{ie(),v(),p(),O=i(),D.__docgenInfo={description:`The events page laid out (ADR-0031 §3): a compact header with the filter trigger and the view
