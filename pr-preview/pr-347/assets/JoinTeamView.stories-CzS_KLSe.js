import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n,t as r}from"./stack-CKd6OPi-.js";import{n as i,t as a}from"./button-W1GRNbO0.js";import{n as o,t as s}from"./input-DRR9bnA7.js";import{n as c,t as l}from"./label-DNAgJ93K.js";function u(e){let t=e.trim(),n=t.indexOf(`/invite/`);return(n===-1?t:t.slice(n+8)).split(/[?#]/)[0].replace(/\/+$/,``).trim()}function d({value:e,onChange:t,onSubmit:n,submitting:r,error:i}){let o=e.trim().length>0&&!r;return(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`h1`,{className:`font-display text-2xl font-bold`,children:`Join your team`}),(0,f.jsx)(`p`,{className:`mt-2 text-sm text-muted-foreground`,children:`Paste the invite link you were sent below — or easiest of all, just click the link directly.`}),(0,f.jsxs)(`form`,{onSubmit:t=>{t.preventDefault(),o&&n(u(e))},className:`mt-6 flex flex-col gap-4`,children:[(0,f.jsxs)(`div`,{children:[(0,f.jsx)(l,{htmlFor:`invite-token`,children:`Invite link`}),(0,f.jsx)(s,{id:`invite-token`,value:e,disabled:r,onChange:e=>t(e.target.value),placeholder:`https://app.teambalance.nl/invite/...`})]}),i&&(0,f.jsx)(`p`,{role:`alert`,className:`text-sm text-destructive`,children:i}),(0,f.jsx)(a,{type:`submit`,disabled:!o,children:r?`Joining…`:`Join`})]}),(0,f.jsxs)(`details`,{className:`mt-8 text-sm text-muted-foreground`,children:[(0,f.jsx)(`summary`,{className:`cursor-pointer font-medium text-foreground`,children:`I don't have a link`}),(0,f.jsx)(`p`,{className:`mt-2`,children:`Ask your team's captain or admin to send you the invite link — they can generate one from the team's Members page. Once you have it, paste it above.`}),(0,f.jsxs)(`p`,{className:`mt-2`,children:[`Starting your own team instead?`,` `,(0,f.jsx)(`a`,{href:`/create-team`,className:`text-blue underline`,children:`Create a team`})]})]})]})}var f;function p(){return(p=e((()=>{i(),o(),c(),f=t(),d.__docgenInfo={description:`Presentational paste-your-invite UI (the /onboarding/join fork branch). value/onChange are
