import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t}from"./iframe-DrbUYmN2.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./stack-D1VBtmRF.js";import{n as a,t as o}from"./button-CmXzxiAJ.js";import{a as s,i as c,n as l,o as u,r as d,s as f,t as p}from"./dialog-Do0x9_OU.js";function m(e,t){return e.consumedAt?`consumed`:e.expiresAt&&new Date(e.expiresAt).getTime()<=t.getTime()?`expired`:`active`}function h(e){return g[e]}var g;function _(){return(_=e((()=>{g={active:`Active`,expired:`Expired`,consumed:`Used`}})))()}function v({codes:e=[],isLoading:t,isError:n,isForbidden:r,isSaving:i,errorCode:a,now:f=new Date,onCreate:h,onRevoke:g}){let[_,v]=(0,b.useState)(null);return(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`h2`,{className:`font-display text-title font-bold`,children:`Creation codes`}),(0,x.jsx)(`p`,{className:`mt-1 text-small text-muted-foreground`,children:`Generate one-time codes that let a new owner create a team.`}),t&&(0,x.jsx)(`p`,{className:`mt-4 text-small text-muted-foreground`,children:`Loading…`}),r&&(0,x.jsx)(`p`,{className:`mt-4 text-small text-muted-foreground`,children:`You don't have access to creation codes.`}),n&&!r&&(0,x.jsx)(`p`,{className:`mt-4 text-small text-red`,children:`Couldn't load creation codes. Please try again.`}),!t&&!n&&!r&&(0,x.jsxs)(`div`,{className:`mt-4 flex flex-col gap-3`,children:[(0,x.jsx)(`div`,{children:(0,x.jsx)(o,{disabled:i,onClick:h,children:`Generate code`})}),a===`CONSUMED`&&(0,x.jsx)(`p`,{className:`text-small text-red`,children:`That code was already used and cannot be revoked.`}),e.length===0?(0,x.jsx)(`p`,{className:`text-small text-muted-foreground`,children:`No creation codes yet. Generate one above.`}):(0,x.jsx)(`ul`,{className:`divide-y divide-border rounded-lg border border-border`,children:e.map(e=>(0,x.jsx)(y,{code:e,status:m(e,f),isSaving:i,onRequestRevoke:v},e.code))}),(0,x.jsx)(p,{open:_!==null,onOpenChange:e=>{e||v(null)},children:(0,x.jsxs)(l,{children:[(0,x.jsxs)(s,{children:[(0,x.jsx)(u,{children:`Revoke code`}),(0,x.jsxs)(d,{children:[`Revoke "`,_?.code,`"? It can no longer be used to create a team.`]})]}),(0,x.jsxs)(c,{children:[(0,x.jsx)(o,{variant:`outline`,onClick:()=>v(null),children:`Cancel`}),(0,x.jsx)(o,{variant:`destructive`,onClick:()=>{_&&g(_),v(null)},children:`Revoke`})]})]})})]})]})}function y({code:e,status:t,isSaving:n,onRequestRevoke:r}){return(0,x.jsxs)(`li`,{className:`flex flex-wrap items-center gap-3 p-3`,children:[(0,x.jsx)(`span`,{className:`font-mono text-small font-medium tracking-wide`,children:e.code}),(0,x.jsx)(`span`,{className:`rounded-full px-2 py-0.5 text-caption font-semibold ${S[t]}`,children:h(t)}),t!==`consumed`&&(0,x.jsx)(o,{variant:`destructive`,size:`sm`,className:`ml-auto`,disabled:n,onClick:()=>r(e),children:`Revoke`})]})}var b,x,S;function C(){return(C=e((()=>{b=t(),a(),f(),_(),x=n(),S={active:`bg-green/12 text-green`,expired:`bg-muted text-muted-foreground`,consumed:`bg-blue/10 text-blue`},v.__docgenInfo={description:`Presentational creation-codes admin UI. Owns only local view state (the revoke-confirm dialog
