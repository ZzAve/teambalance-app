...
/create-team.`,methods:[],displayName:`OnboardingHubView`,props:{onChooseJoin:{required:!0,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},onChooseCreate:{required:!0,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var a,o,s,c,l,u;function d(){return(d=e((()=>{i(),{expect:a,fn:o}=__STORYBOOK_MODULE_TEST__,s={title:`features/onboarding-hub/OnboardingHubView`,component:n,args:{onChooseJoin:o(),onChooseCreate:o()}},c={play:async({canvas:e})=>{await a(e.getByRole(`heading`,{name:/Welcome to TeamBalance/})).toBeInTheDocument(),await a(e.getByText(/You're signed in, but not on a team yet/)).toBeInTheDocument()}},l={parameters:{chromatic:{disableSnapshot:!0}},play:async({canvas:e,userEvent:t,args:n})=>{await t.click(e.getByRole(`button`,{name:/^I have an invite/})),await a(n.onChooseJoin).toHaveBeenCalled(),await t.click(e.getByRole(`button`,{name:/^Create a team/})),await a(n.onChooseCreate).toHaveBeenCalled()}},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvas
  }) => {
...
}`,...l.parameters?.docs?.source}}},u=[`Data`,`Interactions`]})))()}d();export{c as Data,l as Interactions,u as __namedExportsOrder,s as default};