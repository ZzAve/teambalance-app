import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n,t as r}from"./stack-CKd6OPi-.js";import{n as i,t as a}from"./button-BcU7NJ34.js";function o({teams:e=[],isLoading:t,isError:n,isForbidden:r,isEntering:i,wasExpired:o,onEnter:c}){return(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`h2`,{className:`font-display text-2xl font-bold`,children:`Teams`}),(0,s.jsx)(`p`,{className:`mt-1 text-sm text-muted-foreground`,children:`Enter a team to set it up. You stay off its roster, and the team can see that you were here.`}),o&&(0,s.jsx)(`p`,{className:`mt-4 text-sm text-gold-ink`,children:`Your act-as ran out after 60 minutes. Enter a team again to continue.`}),t&&(0,s.jsx)(`p`,{className:`mt-4 text-sm text-muted-foreground`,children:`Loading…`}),r&&(0,s.jsx)(`p`,{className:`mt-4 text-sm text-muted-foreground`,children:`You don't have access to the platform console.`}),n&&!r&&(0,s.jsx)(`p`,{className:`mt-4 text-sm text-red`,children:`Couldn't load teams. Please try again.`}),!t&&!n&&!r&&(0,s.jsx)(`div`,{className:`mt-4`,children:e.length===0?(0,s.jsx)(`p`,{className:`text-sm text-muted-foreground`,children:`No teams yet.`}):(0,s.jsx)(`ul`,{className:`divide-y divide-border rounded-lg border border-border`,children:e.map(e=>(0,s.jsxs)(`li`,{className:`flex flex-wrap items-center gap-3 p-3`,children:[(0,s.jsx)(`span`,{className:`text-sm font-medium`,children:e.name}),(0,s.jsxs)(`span`,{className:`font-mono text-xs text-muted-foreground`,children:[`/`,e.slug]}),(0,s.jsx)(a,{size:`sm`,className:`ml-auto`,disabled:i,onClick:()=>c(e),children:`Enter`})]},e.id))})})]})}var s;function c(){return(c=e((()=>{i(),s=t(),o.__docgenInfo={description:`The platform console's team list (ADR-0024 §6): **every** team, because restricting the list would
