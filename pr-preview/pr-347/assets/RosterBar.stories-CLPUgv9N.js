import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n,t as r}from"./stack-CKd6OPi-.js";import{r as i,s as a}from"./event-fixtures-CuRrQuRB.js";import{n as o,t as s}from"./RosterBar-04ubIBbL.js";var c,l,u,d,f,p,m;function h(){return(h=e((()=>{i(),n(),o(),c=t(),{expect:l,within:u}=__STORYBOOK_MODULE_TEST__,d=`max-w-md overflow-hidden rounded-2xl border border-border/40 bg-card shadow-sm`,f={title:`entities/event/RosterBar`,component:s},p={args:{roster:a()},render:()=>(0,c.jsx)(r,{items:{"One spot open":(0,c.jsx)(`div`,{className:d,children:(0,c.jsx)(s,{roster:a()})}),Critical:(0,c.jsx)(`div`,{className:d,children:(0,c.jsx)(s,{roster:a({positions:[{id:`pos-setter`,label:`Setter`,required:2,attending:2,kind:`PLAYING`},{id:`pos-middle`,label:`Middle`,required:2,attending:0,kind:`PLAYING`}],state:`CRITICAL`})})}),"Lineup fully set":(0,c.jsx)(`div`,{className:d,children:(0,c.jsx)(s,{roster:a({positions:[{id:`pos-setter`,label:`Setter`,required:2,attending:2,kind:`PLAYING`},{id:`pos-libero`,label:`Libero`,required:1,attending:1,kind:`PLAYING`}],state:`LINEUP_SET`})})}),"Headcount target":(0,c.jsx)(`div`,{className:d,children:(0,c.jsx)(s,{roster:a({positions:[],totalTarget:12,totalAttending:8,openSlots:4,state:`HEADCOUNT_SHORT`})})}),"Headcount full":(0,c.jsx)(`div`,{className:d,children:(0,c.jsx)(s,{roster:a({positions:[],totalTarget:12,totalAttending:12,openSlots:0,state:`HEADCOUNT_FULL`})})}),"Tally only":(0,c.jsx)(`div`,{className:d,children:(0,c.jsx)(s,{roster:a({positions:[],totalTarget:void 0,totalAttending:8,openSlots:0,state:`TALLY_ONLY`})})}),"Tracking off":(0,c.jsx)(`div`,{className:d,children:(0,c.jsx)(s,{roster:a({trackRoster:!1,positions:[],totalTarget:void 0,totalAttending:8,openSlots:0,state:`OFF`})})}),"With staff attending":(0,c.jsx)(`div`,{className:d,children:(0,c.jsx)(s,{roster:a({state:`HEADCOUNT_SHORT`,openSlots:1,totalTarget:12,totalAttending:12,positions:[{id:`pos-setter`,label:`Setter`,required:void 0,attending:11,kind:`PLAYING`},{id:`pos-trainer`,label:`Trainer`,required:void 0,attending:1,kind:`STAFF`}]})})}),"Trainer not marked":(0,c.jsx)(`div`,{className:d,children:(0,c.jsx)(s,{roster:a({state:`HEADCOUNT_FULL`,openSlots:0,totalTarget:12,totalAttending:12,positions:[{id:`pos-setter`,label:`Setter`,required:void 0,attending:11,kind:`PLAYING`},{id:`pos-trainer`,label:`Trainer`,required:void 0,attending:1,kind:`PLAYING`}]})})})}}),play:async({canvas:e})=>{let t=t=>u(e.getByRole(`region`,{name:t}));await l(t(`One spot open`).getByText(/4\/5 spots/)).toBeInTheDocument(),await l(t(`One spot open`).getByText(/1 spot open/)).toBeInTheDocument(),await l(t(`One spot open`).getByText(/Middle 1\/2/)).toBeInTheDocument(),await l(t(`Critical`).getByText(/Missing a position/)).toBeInTheDocument(),await l(t(`Critical`).getByText(/Middle 0\/2/)).toBeInTheDocument(),await l(t(`Lineup fully set`).getByText(/3\/3 spots/)).toBeInTheDocument(),await l(t(`Lineup fully set`).getByText(/Lineup set/)).toBeInTheDocument(),await l(t(`Headcount target`).getByText(/8\/12 going/)).toBeInTheDocument(),await l(t(`Headcount target`).getByText(/4 more needed/)).toBeInTheDocument(),await l(t(`Headcount full`).getByText(/12\/12 going/)).toBeInTheDocument(),await l(t(`Headcount full`).getByText(/Full/)).toBeInTheDocument(),await l(t(`Tally only`).getByText(/8 going/)).toBeInTheDocument(),await l(t(`Tally only`).queryByText(/\//)).not.toBeInTheDocument();let n=e.getByRole(`region`,{name:`Tally only`});await l(n.querySelector(`[data-slot="roster-track"]`)).toBeNull();let r=e.getByRole(`region`,{name:`Tracking off`});await l(r.querySelector(`div`)?.textContent??``).toBe(``),await l(t(`With staff attending`).getByText(/11\/12 going \+1 staff/)).toBeInTheDocument(),await l(t(`With staff attending`).getByText(/1 more needed/)).toBeInTheDocument(),await l(t(`Trainer not marked`).getByText(/12\/12 going/)).toBeInTheDocument(),await l(t(`Trainer not marked`).getByText(/Full/)).toBeInTheDocument(),await l(t(`Trainer not marked`).queryByText(/staff/)).not.toBeInTheDocument()}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    roster: makeRoster()
  },
  render: () => <Stack items={{
