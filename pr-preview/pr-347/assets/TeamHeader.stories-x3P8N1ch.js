import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n,t as r}from"./stack-CKd6OPi-.js";import{n as i,t as a}from"./TeamHeader-CXsFrZJc.js";import{n as o,t as s}from"./router-decorator-Bt7JvMFd.js";import{n as c,t as l}from"./button-W1GRNbO0.js";var u,d,f,p,m,h,g;function _(){return(_=e((()=>{s(),n(),c(),i(),u=t(),{expect:d,within:f}=__STORYBOOK_MODULE_TEST__,p={title:`widgets/team-header/TeamHeader`,component:a,decorators:[o],parameters:{router:{initialEntries:[`/t/setpoint-vt/team`]}}},m=(0,u.jsx)(l,{variant:`outline`,children:`Invite Link`}),h={parameters:{chromatic:{disableSnapshot:!0}},args:{isAdmin:!0},render:()=>(0,u.jsx)(r,{items:{Admin:(0,u.jsx)(a,{isAdmin:!0,actions:m}),Member:(0,u.jsx)(a,{isAdmin:!1,actions:m})}}),play:async({canvas:e})=>{let t=t=>f(e.getByRole(`region`,{name:t})),n=t(`Admin`).getByRole(`link`,{name:`Team settings`});await d(n).toBeInTheDocument(),await d(n).toHaveAttribute(`href`,`/t/setpoint-vt/team/settings`),await d(t(`Admin`).getByRole(`button`,{name:`Invite Link`})).toBeInTheDocument(),await d(t(`Member`).getByRole(`heading`,{name:`Team`})).toBeInTheDocument(),await d(t(`Member`).queryByRole(`link`,{name:`Team settings`})).not.toBeInTheDocument(),await d(t(`Member`).queryByRole(`button`,{name:`Invite Link`})).not.toBeInTheDocument()}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  parameters: {
    chromatic: {
