import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n,t as r}from"./stack-CKd6OPi-.js";import{n as i,t as a}from"./button-BcU7NJ34.js";function o({show:e,onReload:t}){return e?(0,s.jsxs)(`div`,{role:`alert`,className:`fixed inset-x-0 bottom-[calc(6rem+env(safe-area-inset-bottom))] z-50 mx-auto flex w-fit max-w-[calc(100%-2rem)] items-center gap-3 rounded-full border border-border bg-card px-4 py-2 shadow-lg`,children:[(0,s.jsx)(`span`,{className:`text-sm`,children:`A new version is available.`}),(0,s.jsx)(a,{size:`sm`,onClick:t,children:`Reload`})]}):null}var s;function c(){return(c=e((()=>{i(),s=t(),o.__docgenInfo={description:`The update-available prompt (caching plan Phase 3), shown only in the one case SwUpdateManager
