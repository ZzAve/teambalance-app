import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{n,t as r}from"./button-DaIhpSqY.js";function i({teams:e=[],isLoading:t,isError:n,isForbidden:i,isEntering:o,wasExpired:s,onEnter:c}){return(0,a.jsxs)(`div`,{children:[(0,a.jsx)(`h2`,{className:`font-display text-title font-bold`,children:`Teams`}),(0,a.jsx)(`p`,{className:`mt-1 text-small text-muted-foreground`,children:`Enter a team to set it up. You stay off its roster, and the team can see that you were here.`}),s&&(0,a.jsx)(`p`,{className:`mt-4 text-small text-gold-ink`,children:`Your act-as ran out after 60 minutes. Enter a team again to continue.`}),t&&(0,a.jsx)(`p`,{className:`mt-4 text-small text-muted-foreground`,children:`Loading…`}),i&&(0,a.jsx)(`p`,{className:`mt-4 text-small text-muted-foreground`,children:`You don't have access to the platform console.`}),n&&!i&&(0,a.jsx)(`p`,{className:`mt-4 text-small text-red`,children:`Couldn't load teams. Please try again.`}),!t&&!n&&!i&&(0,a.jsx)(`div`,{className:`mt-4`,children:e.length===0?(0,a.jsx)(`p`,{className:`text-small text-muted-foreground`,children:`No teams yet.`}):(0,a.jsx)(`ul`,{className:`divide-y divide-border rounded-lg border border-border`,children:e.map(e=>(0,a.jsxs)(`li`,{className:`flex flex-wrap items-center gap-3 p-3`,children:[(0,a.jsx)(`span`,{className:`text-small font-medium`,children:e.name}),(0,a.jsxs)(`span`,{className:`font-mono text-caption text-muted-foreground`,children:[`/`,e.slug]}),(0,a.jsx)(r,{size:`sm`,className:`ml-auto`,disabled:o,onClick:()=>c(e),children:`Enter`})]},e.id))})})]})}var a;function o(){return(o=e((()=>{n(),a=t(),i.__docgenInfo={description:`The platform console's team list (ADR-0024 §6): **every** team, because restricting the list would
