import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-DKhfIwgc.js";import{a as n,r}from"./event-fixtures-CuRrQuRB.js";import{n as i,t as a}from"./chevron-down-DgByg_yz.js";import{n as o,t as s}from"./repeat-BYdf8Rky.js";import{t as c}from"./jsx-runtime-DeHZSEgm.js";import{i as l,n as u,r as d,t as f}from"./router-decorator-B4n0Lpou.js";import{a as p,n as m}from"./team-routes-DJ6pSWuI.js";function h(e,t){if(e.length<2)return null;let n=[...e].sort((e,t)=>e.startTime.localeCompare(t.startTime)),r=n.findIndex(e=>e.id===t);if(r===-1)return null;let i=e=>({id:e.id,startTime:e.startTime,isCurrent:e.id===t});return n.length<=4?{total:n.length,currentPosition:r+1,head:n.map(i),tail:[],hiddenCount:0}:{total:n.length,currentPosition:r+1,head:n.slice(0,g).map(i),tail:n.slice(n.length-_).map(i),hiddenCount:n.length-g-_}}var g,_;function v(){return(v=e((()=>{g=2,_=2})))()}function y(e){return new Date(e).toLocaleDateString(`nl-NL`,{weekday:`short`,day:`numeric`,month:`short`,year:`numeric`})}function b({entry:e}){let t=p(),n=y(e.startTime),r=(0,C.jsxs)(`div`,{className:[`flex items-center gap-2.5 rounded-lg px-2.5 py-1.5 text-small tabular-nums transition-colors`,e.isCurrent?`bg-blue/10 font-semibold text-foreground`:`text-muted-foreground hover:bg-muted/60`].join(` `),children:[(0,C.jsx)(`span`,{className:`h-2 w-2 shrink-0 rounded-full ${e.isCurrent?`bg-blue`:`bg-blue/40`}`}),n,e.isCurrent&&(0,C.jsx)(`span`,{className:`ml-auto rounded-full bg-blue/15 px-2 py-0.5 text-caption font-semibold text-blue`,children:`This one`})]});return e.isCurrent?r:(0,C.jsx)(d,{to:t.event(e.id),children:r})}function x({peek:e}){let[t,n]=(0,S.useState)(!1);return(0,C.jsxs)(`div`,{className:`mt-6 rounded-lg border border-blue/15 bg-blue/5 p-4`,children:[(0,C.jsxs)(`button`,{type:`button`,onClick:()=>n(e=>!e),"aria-expanded":t,className:`flex w-full items-center gap-2 text-left`,children:[(0,C.jsx)(`span`,{className:`flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-blue/10 text-blue`,children:(0,C.jsx)(s,{size:15})}),(0,C.jsxs)(`div`,{className:`min-w-0`,children:[(0,C.jsx)(`p`,{className:`text-small font-bold leading-tight`,children:`Part of a series`}),(0,C.jsxs)(`p`,{className:`text-caption text-muted-foreground`,children:[`Occurrence `,e.currentPosition,` of `,e.total]})]}),(0,C.jsx)(a,{size:18,className:`ml-auto shrink-0 text-muted-foreground transition-transform ${t?`rotate-180`:``}`})]}),t&&(0,C.jsxs)(`div`,{className:`mt-3 flex flex-col gap-1`,children:[e.head.map(e=>(0,C.jsx)(b,{entry:e},e.id)),e.hiddenCount>0&&(0,C.jsxs)(`div`,{className:`flex items-center gap-2 px-2.5 py-1 text-caption italic text-muted-foreground`,children:[(0,C.jsx)(`span`,{className:`h-px flex-1 bg-border`}),`+`,e.hiddenCount,` more`,(0,C.jsx)(`span`,{className:`h-px flex-1 bg-border`})]}),e.tail.map(e=>(0,C.jsx)(b,{entry:e},e.id))]})]})}var S,C;function w(){return(w=e((()=>{S=t(),l(),i(),o(),m(),C=c(),x.__docgenInfo={description:`A "part of a series" disclosure on the event-detail route (ADR-0014). The membership line is
