import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-DKhfIwgc.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./button-DaIhpSqY.js";import{n as a,t as o}from"./input-BgsZWF84.js";import{n as s,t as c}from"./label-YdXdusZw.js";function l(e){return e||void 0}function u(e){return l(e.start)!==void 0||l(e.end)!==void 0}function d(e){let t=l(e.start),n=l(e.end);return t&&n&&n<t?`End date must be on or after the start date.`:null}function f(e,t){return l(e.start)!==l(t.start)||l(e.end)!==l(t.end)}function p({season:e={},isLoading:t,isError:n,isSaving:r,error:a,onSave:s}){let[l,p]=(0,m.useState)(e.start??``),[g,_]=(0,m.useState)(e.end??``),v={start:l,end:g},y=d(v),b=f(e,v),x=b&&(u(e)||u(v));return(0,h.jsxs)(`div`,{className:`flex flex-col gap-4`,children:[(0,h.jsxs)(`div`,{children:[(0,h.jsx)(`h2`,{className:`font-display text-title font-bold`,children:`Season`}),(0,h.jsx)(`p`,{className:`mt-1 text-small text-muted-foreground`,children:`Bound your team's events to a season. Once set, events cannot be scheduled outside this window.`})]}),t&&(0,h.jsx)(`p`,{className:`text-small text-muted-foreground`,children:`Loading…`}),n&&(0,h.jsx)(`p`,{className:`text-small text-red`,children:`Couldn't load team settings. Please try again.`}),!t&&!n&&(0,h.jsxs)(h.Fragment,{children:[!u(e)&&!b&&(0,h.jsx)(`p`,{className:`text-small text-muted-foreground`,children:`No season set — events can be scheduled on any date.`}),(0,h.jsxs)(`div`,{className:`flex flex-wrap gap-4`,children:[(0,h.jsxs)(`div`,{className:`flex flex-col gap-1`,children:[(0,h.jsx)(c,{htmlFor:`season-start`,children:`Start date`}),(0,h.jsx)(o,{id:`season-start`,type:`date`,value:l,max:g||void 0,onChange:e=>p(e.target.value),className:`w-48`})]}),(0,h.jsxs)(`div`,{className:`flex flex-col gap-1`,children:[(0,h.jsx)(c,{htmlFor:`season-end`,children:`End date`}),(0,h.jsx)(o,{id:`season-end`,type:`date`,value:g,min:l||void 0,onChange:e=>_(e.target.value),className:`w-48`})]})]}),y&&(0,h.jsx)(`p`,{className:`text-small text-red`,children:y}),x&&!y&&(0,h.jsx)(`p`,{className:`rounded-lg border border-gold/40 bg-gold/10 px-3 py-2 text-small text-foreground`,role:`alert`,children:`Changing the season won't move or delete existing events — some may now fall outside the new window.`}),a&&(0,h.jsx)(`p`,{className:`text-small text-red`,children:a}),(0,h.jsx)(`div`,{children:(0,h.jsx)(i,{disabled:r||!b||!!y,onClick:()=>{y||!b||s({start:l||void 0,end:g||void 0})},children:r?`Saving…`:`Save season`})})]})]})}var m,h;function g(){return(g=e((()=>{m=t(),r(),a(),s(),h=n(),p.__docgenInfo={description:`Presentational Team Settings UI — the complete section, heading and all: the season start/end
