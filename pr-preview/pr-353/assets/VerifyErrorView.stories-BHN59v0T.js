import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{i as n,n as r,r as i,t as a}from"./router-decorator-B4n0Lpou.js";import{n as o,t as s}from"./button-DaIhpSqY.js";function c({message:e,onLogout:t}){return(0,l.jsxs)(`div`,{className:`mx-auto mt-16 max-w-sm text-center`,children:[(0,l.jsx)(`h1`,{className:`font-display text-title font-bold`,children:`Link expired`}),(0,l.jsx)(`p`,{className:`mt-3 text-small text-muted-foreground`,children:e}),(0,l.jsxs)(`div`,{className:`mt-6 flex items-center justify-center gap-4`,children:[(0,l.jsx)(i,{to:`/login`,className:`text-small font-medium text-blue`,children:`Back to login`}),t&&(0,l.jsx)(s,{variant:`ghost`,onClick:t,children:`Log out`})]})]})}var l;function u(){return(u=e((()=>{n(),o(),l=t(),c.__docgenInfo={description:'The `/auth/verify` error state, rendered *instead of* RootLayout (ADR-0027 §3). "Back to login" is\nalways offered; the escape hatch is added when a session exists — most importantly the\n"authenticated but stranded, no team" invite-accept-failure edge, where a client-only logout is the\nonly way out. Prop-only; the container reads the session and passes `onLogout`.',methods:[],displayName:`VerifyErrorView`,props:{message:{required:!0,tsType:{name:`string`},description:`The failure copy — a missing/expired magic link, or the invite-accept-failure message.`},onLogout:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:`Local escape hatch (ADR-0027 §3): a client-only \`clearSession()\`. Present when a session exists —
