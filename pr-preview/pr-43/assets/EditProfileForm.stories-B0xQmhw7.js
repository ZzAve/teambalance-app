import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-7ra-rxTo.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{i as r,n as i,r as a,t as o}from"./input-DSfQ-uEk.js";import{n as s,t as c}from"./label-oJWJ1dSz.js";import{n as l,t as u}from"./PositionPicker-B6Ee9jzd.js";function d(e){let t=e.trim();return t.length===0?`Display name is required.`:t.length>f?`Display name must be ${f} characters or fewer.`:null}var f;function p(){return(p=e((()=>{f=100})))()}function m(e,t){return e.length===0||t?null:`Please select a position.`}function h({currentName:e,positions:t,currentPositionId:n,isSaving:r,onSubmit:i,errorCode:s}){let[l,f]=(0,g.useState)(e),[p,h]=(0,g.useState)(n),[v,y]=(0,g.useState)(!1),b=d(l),x=m(t,p),S=b??x;return(0,_.jsxs)(`form`,{onSubmit:e=>{if(e.preventDefault(),S){y(!0);return}i(l.trim(),p)},className:`flex flex-col gap-4`,children:[(0,_.jsxs)(`div`,{children:[(0,_.jsx)(c,{htmlFor:`displayName`,children:`Display name`}),(0,_.jsx)(o,{id:`displayName`,name:`displayName`,value:l,onChange:e=>{f(e.target.value),y(!0)},"aria-invalid":v&&b?!0:void 0,placeholder:`Your name`}),v&&b&&(0,_.jsx)(`p`,{className:`mt-1 text-sm text-red-500`,children:b}),s===`NAME_TAKEN`&&(0,_.jsx)(`p`,{className:`mt-1 text-sm text-red-500`,children:`That display name is already taken.`})]}),t.length>0&&(0,_.jsxs)(`div`,{children:[(0,_.jsx)(c,{htmlFor:`position`,children:`Position`}),(0,_.jsx)(u,{"aria-label":`Position`,positions:t,value:p,onChange:e=>{h(e),y(!0)}}),v&&x&&(0,_.jsx)(`p`,{className:`mt-1 text-sm text-red-500`,children:x})]}),(0,_.jsx)(a,{type:`submit`,disabled:r||!!S,children:r?`Saving...`:`Save`})]})}var g,_;function v(){return(v=e((()=>{g=t(),l(),r(),i(),s(),p(),_=n(),h.__docgenInfo={description:`Presentational edit-profile form. Owns only the local field + touched state; the current member
